...
Qualquer dúvida sobre o uso de AEM ou erros técnicos que você possa ter deve ser relatada por meio do processo de suporte normal através do [Portal de suporte ao cliente Experience Cloud](https://experienceleague.adobe.com/?support-solution=Experience+Manager#support) ou discutida na [comunidade Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community).

...
* Instale [MySQL Server](https://dev.mysql.com/downloads/mysql/) Community Server versão 5.6
...
* Insira os seguintes valores:
   ...
   * **URIJ** de conexão DBC:  `jdbc:mysql://localhost:3306/aem63reporting` especifique o servidor no lugar de localhost se o servidor MySQL não for igual ao servidor AEM &#39;this&#39;
...
* Em cada instância AEM publicação
* Conectado com privilégios de administrador
* Acesse o [console da Web](../../help/sites-deploying/configuring-osgi.md)

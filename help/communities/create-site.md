...
Na etapa [Modelo de](sites-console.md#step2013asitetemplate)site, insira um título, descrição, o nome do URL e selecione um modelo de site da comunidade, por exemplo:
...
Visite o tutorial [Introdução ao AEM Communities para ativar](getting-started-enablement.md) e experimente trabalhar com os recursos de ativação.
...
As configurações [de](sites-console.md#translation) Tradução especificam o idioma base do site, bem como se o UGC pode ou não ser traduzido e para qual idioma, se houver.
...
* Selecione **[!UICONTROL Traduzir a página inteira]**
...
>1. Selecionar **[!UICONTROL agentes no autor]**
>1. Selecionar agente **[!UICONTROL padrão (publicar)]**
...
Para este novo site da comunidade, dado o nome do site &quot;engajar&quot; na Etapa 1, os quatro novos grupos de usuários podem ser vistos no console [](members.md) Grupos (navegação global: Comunidades, Grupos):
...
Após qualquer modificação, lembre-se de **salvar** e **republicar** o site.

...
Um auxiliar de bloco que testa o valor atual de [modo WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) contra uma lista de modos separada por cadeias de caracteres.
...
* **modo**: String
   ...
   (opcional) Uma lista separada por vírgulas de [modos WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) para testar se definido.

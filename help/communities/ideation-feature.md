...
* **[!UICONTROL Título]** da ideiaO título de exibição da ideia. O padrão é `Ideation`.
...
* **[!UICONTROL Permitir que os usuários excluam comentários e tópicos]** Se marcados, permitirá que os membros excluam os comentários e ideias publicados. O padrão está desmarcado.
...
* **[!UICONTROL Limite de sugestão]** Insira o número de tags a serem exibidas como uma sugestão para o membro postar no fórum. Um valor de **-** 1 significa sem limite. O padrão é 0.

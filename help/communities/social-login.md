...
* *Adicionar um novo aplicativo do Facebook:*
   ...
   * Para *Categoria*, recomendamos selecionar *Aplicativos para páginas,*, mas pode ser qualquer coisa.
...
1. Vá para **[!UICONTROL Ferramentas > Geral > Navegador de configuração]**. Selecione o contexto e edite as propriedades. Habilite Configurações de nuvem se ainda não estiver habilitado.
...
1. Selecione o ícone de lápis para abrir para edição.
   ...
   * **[!UICONTROL Atualizar]**
usuárioSe marcada, atualiza os dados do usuário no repositório em cada logon para refletir as alterações no perfil ou os dados adicionais solicitados. O padrão está desmarcado.
...
1. Na navegação global, selecione **[!UICONTROL Ferramentas > Cloud Services > Configuração de login do Twitter Social]**.
...
1. Criar/editar a configuração do serviço de nuvem do Twitter.
   ...
   * **[!UICONTROL consumer key]** (*obrigatório*) Digite a  **chave do** consumidor (API) para o aplicativo do Twitter. Isso identifica a instância [Adobe Granite OAuth Application and Provider](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#AdobeGraniteOAuthApplicationandProvider) criada a partir da caixa de diálogo.

   * **[!UICONTROL consumer secret]**  (*obrigatório*) Insira a  ***Secretaria*** Consumidor (API) do aplicativo do Twitter.

   * **[!UICONTROL Criar]** usuáriosSe marcada, o logon com uma conta do Twitter criará uma entrada de usuário AEM e as adicionará como membro ao(s) grupo(s) de usuários selecionado(s). O padrão está marcado (altamente recomendado).

   * **[!UICONTROL Mascarar]** IDs de usuárioDeixe desmarcada.
...
**&amp;ast;** Para o  **** nameoauthid-*123*, substitua  *123* pelo  ***Keyser do Facebook*** App  ***ID ou do Twitter***   ****   [ ](social-login.md#adobe-granite-oauth-application-and-provider)Consumer (API) que é o valor do ClientIDno Aplicativo OAuth e na configuração doProviderme OaAdobe.

...
1. Selecione o ícone de lápis para abrir para edição.
   ...
   * **[!UICONTROL Atualizar usuário]** Se marcada, atualiza os dados do usuário no repositório em cada login para refletir as alterações no perfil ou os dados adicionais solicitados. O padrão está desmarcado.
...
1. Para URL *de* retorno de chamada - insira https://&lt;servidor>/.
...
**&amp;ast;** Para o **nome** oauthid-*123*, substitua *123* pela ID ***do*** aplicativo do Facebook ou chave ***de*** **** [](social-login.md#adobe-granite-oauth-application-and-provider)consumidor (API) do Twitter que é o valor da ID do cliente do na configuração OAuth do Aplicativo OaAdobe Granite e doProviderme.

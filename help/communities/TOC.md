...
# Guia do usuário do AEM 6.4 Communities {#communities}
...
+ Introduction to AEM Communities {#introduction}
   ...
   + [Novidades do AEM 6.4 Communities](whats-new-aem-communities.md)
...
+ Desenvolvimento {#develop}
   ...
   + [Princípios básicos do fluxo de atividade](essentials-activities.md)
   ...
   + [Componentes de eventos OSGi para comunidades](events.md)
   ...
   + [Princípios básicos do líder](leaderboard.md)
   ...
   + [Essenciais de pontuação e símbolos](configure-scoring.md)
   ...
   + [SRP e UGC Essentials](srp-and-ugc.md)
...
+ Criação {#authoring}
   ...
   + [Recurso de transmissão de atividades](activities.md)

...
Para excluir dados do usuário do Adobe Analytics, siga o fluxo de trabalho do GDPR Analytics; como a API não exclui dados do usuário do Adobe Analytics.

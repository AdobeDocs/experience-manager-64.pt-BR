...
Todos os sites [da](overview.md#communitiessites) comunidade incluem uma página de perfil do usuário para o membro conectado que exibirá atividades de membros da mesma maneira.
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>Consulte Recurso <a href="activities.md">Atividades Streams</a></td> 
  </tr>
 </tbody>
</table>
...
Uma estrutura de site da comunidade que inclui a função [Stream de](functions.md#activity-stream-function)Atividade inclui um `activity streams` componente configurado.

...
* Atualização da versão jQuery fornecida no ContextHub para 3.4.1.
...
* As coleções são removidas da visualização ao aplicar qualquer filtro nos ativos AEM acessados do Adobe Asset Link (CQ-4280534).

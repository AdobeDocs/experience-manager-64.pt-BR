...
1. [Pacote de recursos do AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/release-notes.html) ou [AEM 6.3](https://helpx.adobe.com/experience-manager/6-3/release-notes.html) + telas mais recentes
...
As etapas do tutorial e as capturas de tela são executadas usando o [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp). [Os IDEs Eclipse](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/aem-eclipse.html) ou [IntelliJ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/ht-intellij.html) também podem ser usados para concluir o tutorial. Mais informações sobre como usar um IDE para desenvolver [com o AEM podem ser encontradas aqui.](https://helpx.adobe.com/experience-manager/kt/sites/using/getting-started-wknd-tutorial-develop/part1.html#eclipse-ide)

>[!NOTE]
>
>Antes de iniciar este tutorial, é recomendável ter revisado o seguinte:
>
>1. [Noções básicas sobre o AEM Screens](https://helpx.adobe.com/experience-manager/kt/screens/using/screens-concepts-feature-video-understand.html)
>1. [Guia de Início Rápido de Telas](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/kickstart-for-aem-screens.html)
>
...
1. Adicione as seguintes propriedades à biblioteca de clientes compartilhados:
   ...
   * `categories`| String[] | `cq.screens.components`
   ...
   É uma prática recomendada nunca expor nenhum caminho diretamente para /apps em um ambiente de produção. A propriedade allowProxy garante que a biblioteca do cliente CSS e JS sejam referenciadas por meio de um prefixo of/etc.clientlibs. Mais informações sobre a propriedade [allowProxy podem ser encontradas aqui.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/clientlibs.html#main-pars_title_8ced)
...
1. No [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp#/apps/settings/wcm/designs) , navegue até `/apps/settings/wcm/designs`

...
1. Selecione o link do Adobe Experience Manager (canto superior esquerdo) e, em seguida, o Screens. Como alternativa, você pode navegar diretamente de `http://localhost:4502/screens.html/content/screens`
...
O exemplo a seguir mostra a criação de um Sequence Channel **One** para um **DemoProject** do projeto do Screens.
...
>[!NOTE]
>
>Se você encontrar problemas ao fazer o upload de vídeos no seu canal, consulte [Solução de problemas com vídeos](troubleshoot-videos.md), em Administração do Screens.
...
1. Clique em **Propriedades **na barra de ações para exibir/editar as propriedades do canal. As guias a seguir permitem que você altere as opções.
...
1. Clique no Canal que deseja editar.
1. Click **View Dashboard** from the action bar to view the dashobard. Os painéis **INFORMAÇÕES DO CANAL** e **EXIBIÇÕES ATRIBUÍDAS** são abertos, conforme mostrado na figura abaixo:
...
1. Navegue até o canal **TestChannel** da pasta **Channels** em seu **TestProject**.

   Selecione o canal.

   ![chlimage_1-45](assets/chlimage_1-45.png)

   Clique em **Exibir painel** na barra de ações para visualizar o status do player. O painel **INFORMAÇÕES DO CANAL **fornece informações sobre se o canal está online ou offline.
...
1. Verifique **Tornar o canal online** para torná-lo online.
   ...
   O painel do canal é exibido e o painel **INFORMAÇÕES DO CANAL** mostra o status online do player.

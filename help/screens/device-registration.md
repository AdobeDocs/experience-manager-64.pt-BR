...
1. No AEM, navegue até a pasta **Dispositivos** do seu projeto.
   ...
   >[!NOTE]
   >
   >Para obter mais informações sobre como criar um novo projeto para o Screens no painel AEM, consulte [Criar e gerenciar projeto](/help/screens/creating-a-screens-project.md)de telas.
...
1. Toque/clique em** Finish** para concluir o processo de registro.
   ...
   >[!NOTE]
   >
   >Para saber mais sobre como criar e gerenciar uma exibição para o seu projeto do Screens, consulte [Criar e gerenciar exibições](/help/screens/managing-displays.md).
...
Para saber mais sobre o AEM Screens Player, consulte [AEM Screens Player](/help/screens/working-with-screens-player.md).

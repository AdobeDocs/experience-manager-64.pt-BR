...
seo-description: 'Siga esta página para saber mais sobre modelos de página para aplicativos móveis. '
...
Conforme descrito em Modelos [de página do](/help/mobile/apps-architecture.md)AEM, cada componente pode produzir um fragmento do JavaScript para consumir o conteúdo JSON exposto pela `data` promessa. De acordo com as convenções angulares, um controlador só deve ser usado para atribuir variáveis ao escopo.
...
Por convenção, no AEM, o nó /etc contém conteúdo clientlib estático. O diretório etc contém as bibliotecas Topcoat, AngularJS e We.Retail ng-clientlibsall.

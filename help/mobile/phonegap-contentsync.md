...
>[!NOTE]
>
>Para obter mais informações sobre as diretrizes para desenvolver manipuladores de Sincronização de conteúdo, consulte os manipuladores de aplicativos prontos para uso, consulte [Desenvolvimento de manipuladores](/help/mobile/contentsync-app-handlers.md)de sincronização de conteúdo.
...
**conteúdo** Renderize conteúdo usando o processamento de solicitação Sling padrão.

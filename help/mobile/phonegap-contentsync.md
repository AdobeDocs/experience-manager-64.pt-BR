...
>[!NOTE]
>
>Os aplicativos PhoneGap que você cria usando ferramentas AEM já estão configurados para usar páginas AEM como conteúdo por meio da Sincronização de conteúdo.

...
Tire proveito do [Mobile App Analytics](https://www.adobe.com/ca/solutions/digital-analytics/mobile-web-apps-analytics.html) em seus aplicativos AEM por meio da integração com o [Adobe Mobile Services](https://www.adobe.com/marketing-cloud/mobile-marketing.html).
...
Há várias APIs de rastreamento fornecidas na API de plug-in do Phonegap do [AMS.](https://marketing.adobe.com/resources/help/en_US/mobile/ios/phonegap_methods.html)

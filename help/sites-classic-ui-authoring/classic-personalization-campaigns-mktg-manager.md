...
* **[Painel](#dashboard)**Que é dividido em quatro painéis:
   ...
   * [Listas](#lists)
      ...
      Este painel mostra as listas que você já criou, juntamente com o número de clientes potenciais nessa lista. Nesse painel, é possível criar uma nova lista diretamente ou através da importação de leads.
   ...
   * [Segmentos](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#anoverviewofsegmentation)
      ...
      Este painel mostra os segmentos que você definiu. Os segmentos permitem caracterizar uma coleção de visitantes que compartilham determinadas características.
...
* **[Leads](#leads)**
   ...
   Aqui você pode gerenciar seus clientes potenciais. É possível criar ou importar leads, editar detalhes específicos para leads individuais ou excluir quando não forem mais necessários. Também é possível adicionar os leads a diferentes grupos, chamados de Listas. **Observação:** a Adobe não planeja aprimorar mais esse recurso.

   A recomendação é [aproveitar o Adobe Campaign e a integração com o AEM](/help/sites-administering/campaign.md).

* **[Listas](#lists)**

   Aqui você pode gerenciar suas listas (de clientes potenciais).**Observação:** a Adobe não planeja aprimorar mais esse recurso.

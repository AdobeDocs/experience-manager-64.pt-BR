   ...
   * **Criar uso da lista**
      ...
      * **Opções para a lista fixa**
         ...
         * **Páginas**
            ...
            Selecione uma lista de páginas. Use `+` to add more entries and the up/down buttons to adjust the order.
      * **Opções de pesquisa**
...
![chlimage_1-26](assets/chlimage_1-26.png) _ ![dc_chart_use](assets/dc_chart_use.png)

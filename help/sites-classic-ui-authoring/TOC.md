...
+ Introdução à criação da interface clássica {#introduction}
   ...
   + [Criação na interface clássica](classicui.md)
...
+ Criação {#authoring}
   + [Criação de páginas](classic-page-author.md)
   ...
   + [Componentes para criação de página](classic-page-author-edit-mode.md)
   + [Atalhos de teclado ao editar páginas](classic-page-author-keyboard-shortcuts.md)
+ Recursos de site e página {#siteandpage}
   ...
   + [Configuração de componentes no modo de design](classic-page-author-design-mode.md)
...
+ Personalização {#personalization}
   ...
   + [Rastreamento de emails devolvidos](classic-personalization-campaigns-email-tracking-bounces.md)
...
+ Adobe Campaign {#campaign}
   ...
   + [Direcionamento da sua Adobe Campaign](classic-personalization-ac-target.md)
+ Criação de ativos na interface clássica {#assets}
   + [Trabalhar com ativos](classicui-assets.md)
   + [Entrega de ativos da Dynamic Media](dynamic-media-assets-delivering.md)
   + [Adicionar ativos Dynamic Media às páginas](dynamic-media-assets-adding-to-page.md)

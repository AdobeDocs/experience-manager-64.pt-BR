...
Mesmo se o componente de vídeo Dynamic Media Classic for recomendado para exibição de vídeos do Dynamic Media Classic, esta seção descreve o uso de vídeos do Dynamic Media Classic com o Componente [!UICONTROL de vídeo] Foundation no AEM, para fins de integridade.

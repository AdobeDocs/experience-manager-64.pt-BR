---
title: Guia do usuário de criação da interface clássica AEM 6.4
seo-title: Guia do usuário de criação da interface clássica AEM 6.4
description: 'Este guia aborda os conceitos de criação em AEM na interface clássica do usuário. '
seo-description: 'Abrange os conceitos de criação em AEM na interface clássica. '
...
# Guia do usuário de criação da interface clássica AEM 6.4

Este guia aborda os conceitos de criação em AEM na interface clássica do usuário.

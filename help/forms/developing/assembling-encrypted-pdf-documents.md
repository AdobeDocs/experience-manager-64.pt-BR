...
O serviço de criptografia não precisa fazer parte da instalação de formulários AEM para criptografar um documento PDF com uma senha. Consulte [Criptografando e descriptografando Documentos](/help/forms/developing/encrypting-decrypting-pdf-documents.md)PDF.

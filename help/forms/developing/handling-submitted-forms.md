...
>[!NOTE]
>
>Os cálculos e validações devem ser renderizados de volta ao usuário. (Consulte [Calculando Dados de Formulário](/help/forms/developing/calculating-form-data.md#calculating-form-data).)

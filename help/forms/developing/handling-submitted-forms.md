...
* **2 (Validar):** Os dados de formulário validados pelo serviço Forms e os resultados devem ser renderizados de volta para o usuário.
...
>[!NOTE]
>
>Os cálculos e validações devem ser renderizados de volta ao usuário. (Consulte [Calculando dados](/help/forms/developing/calculating-form-data.md#calculating-form-data)do formulário.)

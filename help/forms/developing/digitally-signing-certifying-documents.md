...
* Valide as assinaturas digitais localizadas em um documento PDF. (Consulte [Verificando Assinaturas Digitais](#unresolvedlink-lc-si).)
* Valide todas as assinaturas digitais localizadas em um documento PDF. (Consulte [Verificando várias assinaturas digitais](#unresolvedlink-lc-si).)
...
Iterar por cada assinatura. Ou seja, para cada assinatura, verifique a assinatura digital e verifique a identidade do assinante e o status de cada assinatura. (Consulte [Verificando Assinaturas Digitais](#unresolvedlink-lc-si).)

...
* Validar assinaturas digitais localizadas em um documento PDF. (Consulte [Verificando Assinaturas Digitais](#unresolvedlink-lc-si).)
...
[Verificar assinaturas digitais usando a API do Java](#unresolvedlink-lc-si)
...
[Verificar várias assinaturas digitais usando a API do Java](#unresolvedlink-lc-si)

[Verificação de várias assinaturas digitais usando a API do serviço da Web](#unresolvedlink-lc-si)
...
[Verificação de várias assinaturas digitais](#unresolvedlink-lc-si)

...
se o AEM Forms estiver configurado para permitir que somente documentos protegidos sejam carregados e o usuário não tiver a função* Document Upload Application User *, uma exceção será lançada. Se o usuário tiver essa função, o arquivo será carregado e o processo será chamado.

...
description: 'Use a numeração de Bates para montar documentos PDF usando a API Java e Web Service. '
seo-description: 'Use a numeração de Bates para montar documentos PDF usando a API Java e Web Service. '

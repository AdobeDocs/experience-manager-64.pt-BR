...
Este documento DDX une dois documentos PDF chamados *map.pdf* e* direcçõespdf* em um único documento PDF. O documento PDF resultante contém um cabeçalho que consiste em um identificador de página exclusivo. Por exemplo, o documento na ilustração acima mostra 000016.
...
[Início rápido (modo SOAP): Montagem de um documento PDF com numeração de datas usando a API Java](/help/forms/developing/assembler-service-java-api-quick.md#quick-start-soap-mode-assembling-a-pdf-document-with-bates-numbering-using-the-java-api)

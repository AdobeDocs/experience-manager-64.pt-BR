...
+ Atualizar o AEM Forms {#upgrade-aem-forms}
   ...
   + Atualizar formulários AEM no JEE {#aem-forms-jee-upgrade}
      ...
      + [Atualização do LiveCycle ES4 SP1 para o AEM Forms no JEE para WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
...
+ Referência do desenvolvedor {#developer-reference}
   + [Noções básicas sobre desenvolvedor](https://docs.adobe.com/content/help/en/experience-manager-64/developing/home.html)

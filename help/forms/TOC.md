...
+ Introdução {#getting-started}
   ...
   + AEM Forms Reference Collaterals {#aem-forms-reference-collaterals}
      + [Configurar e configurar os Formulários AEM nos sites de referência](using/setup-reference-sites.md)
      ...
      + [Configurar o Microsoft Dynamics 365 para o fluxo de trabalho de hipoteca do site de referência We.Finance](using/ms-dynamics-configuration-home-mortgage.md)
+ Instalar e configurar o AEM Forms {#install-aem-forms}
   ...
   + Instalar AEM Forms em OSGi {#osgi-installation}
      + [Plataformas compatíveis com AEM Forms no OSGi](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + Instalar o AEM Forms no JEE {#jee-installation}
      + [Plataformas compatíveis com AEM Forms no JEE](using/aem-forms-jee-supported-platforms.md)
      ...
      + [Instalação e implantação de AEM Forms no JEE para WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      ...
      + [Preparação para instalar o AEM Forms (Cluster do Servidor)](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      ...
      + [Configuração do Adobe Experience Manager Forms no JEE no Cluster do WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
   + Configurar AEM Forms {#configure-aem-forms}
      ...
      + [Configurar o Conector para Microsoft SharePoint](http://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
      + [Conexão do AEM Forms com o Adobe LiveCycle](using/aem-livecycle-connector.md)
      + [Configuração do AEM Forms para enviar dados de formulário a um AEM Forms em um processo JEE](using/submit-form-data-livecycle-process.md)
...
+ Atualizar o AEM Forms {#upgrade-aem-forms}
   ...
   + Atualizar o AEM Forms no OSGi {#aem-forms-osgi-upgrade}
      + [Atualizar para o AEM Forms 6.4 no OSGi](using/upgrade-forms-osgi.md)
   ...
   + Atualizar AEM Forms no JEE {#aem-forms-jee-upgrade}
      + [Preparação para atualizar o AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      + [Lista de verificação e planejamento de atualização do Adobe Experience Manager Forms em JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Atualização para AEM Forms 6.4 no JEE](using/upgrade-forms-jee.md)
      ...
      + [Atualização para AEM Forms no JEE para JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [Atualização do LiveCycle ES4 SP1 para o Adobe Experience Manager Forms no JEE para WebLogic](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      ...
      + [Atualização do LiveCycle ES4 SP1 para o Adobe Experience Manager Forms no JEE para WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
+ Gerenciar AEM Forms {#manage-administer-aem-forms}
   ...
   + [Baixar um XFA ou um modelo de formulário PDF](using/download-xfa-or-pdf-form.md)
   ...
   + Manipular dados do usuário {#handling-user-data}
      ...
      + [Fluxos de trabalho JEE do Forms](using/forms-workflow-jee-handling-user-data.md)
   ...
   + Otimizar o ambiente do AEM Forms {#hardening-aem-forms-environment}
      + [Otimização e proteção de formulários do AEM no ambiente OSGi](using/hardening-securing-aem-forms-environment.md)
      + [Considerações gerais de segurança para AEM Forms no JEE](using/general-security-considerations.md)
      + [Otimização do AEM Forms no ambiente JEE](using/hardening-aem-forms-jee-environment.md)
...
+ Formulários adaptáveis - Criação básica {#adaptive-forms-basic-authoring}
   ...
   + [Incorpore um formulário adaptável ou uma comunicação interativa na página de sites do AEM](using/embed-adaptive-form-aem-sites.md)
   + [Incorporar formulários adaptáveis à página da Web externa](using/embed-adaptive-form-external-web-page.md)
   ...
   + [Texto de espaço reservado em AEM Forms](using/placeholder-text-in-aem-forms-.md)
...
+ Formulários adaptáveis - Criação avançada {#adaptive-forms-advanced-authoring}
   ...
   + [Integração do Adobe Sign com o AEM Forms](using/adobe-sign-integration-adaptive-forms.md)
...
+ Fluxos de trabalhos {#workflows}
   ...
   + [Fluxo de trabalho centrado em formulários no OSGi - Referência em etapas](using/aem-forms-workflow-step-reference.md)
   ...
   + [Ações e recursos de fluxos de trabalho do AEM centrados em formulários em fluxos de trabalho do OSGi e do AEM Forms JEE](using/capabilities-osgi-jee-workflows.md)
   + [Iniciar APIs de serviços de documento do fluxo de trabalho do AEM](using/initiating-document-services-apis-aem.md)
+ AEM Forms Workspace {#use-aem-forms-workspace}
   + [Introdução ao espaço de trabalho do AEM Forms](using/introduction-html-workspace.md)
   + [Trabalhar com o espaço de trabalho do AEM Forms](using/html-workspace-overview.md)
   + [Arquitetura do espaço de trabalho do AEM Forms](using/html-workspace-architecture.md)
   + [Os recursos do espaço de trabalho do AEM Forms não estão disponíveis no Flex workspace](using/features-html-workspace-available-flex.md)
   ...
   + [Introdução à Personalização do espaço de trabalho de formulários do AEM](using/introduction-customizing-html-workspace.md)
   ...
   + [Alteração do local da interface do usuário do espaço de trabalho do AEM Forms](using/changing-locale-user-interface.md)
   ...
   + [Uso de um formulário adaptável no Espaço de trabalho HTML](using/using-adaptive-form-html-workspace.md)
   + [Integrando o espaço de trabalho de AEM Forms com o Microsoft Office SharePoint Server](using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
...
+ Aplicativo do AEM Forms {#aem-forms-app}
   + [Introdução ao aplicativo AEM Forms](using/aem-forms-app.md)
   + [Configurar o ambiente para o aplicativo AEM Forms](using/setup-environment-mobile-workspace.md)
...
+ Formulários HTML5 {#html5-forms}
   + [Introdução a formulários HTML5](using/introduction.md)
   ...
   + [Perguntas frequentes para formulários HTML5](using/faq.md)
...
+ Integrar AEM Forms com soluções da Experience Cloud {#integrate-aem-forms-with-experience-cloud-solutions}
...
+ Publicar e processar AEM Forms {#publish-process-aem-forms}
   ...
   + [Gerenciar aplicativos e tarefas do Forms na Caixa de entrada do AEM](using/manage-applications-inbox.md)
...
+ Serviços de documento {#use-document-services}
   + [Visão geral dos serviços de documento do AEM](using/overview-aem-document-services.md)
   ...
   + [Serviço de formulários com código de barras](using/using-barcoded-forms-service.md)
   ...
   + [Uso programático dos serviços de documento do AEM](using/aem-document-services-programmatically.md)
...
+ Segurança de documentos {#use-document-security}
   ...
   + [Ativar o AEM para pesquisar documentos PDF protegidos pela segurança de documentos](using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
   + [Leitor estendendo documentos PDF protegidos por política usando a Biblioteca Portable Protection](using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   + [Permitir que o AEM pesquise documentos protegidos pela segurança do documento em PDF e documentos do Microsoft Office](using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
...
+ Ajuda do administrador para AEM Forms no JEE {#administrator-help}
   ...
   + Configurando o Gerenciamento de Usuário {#configure-user-management}
      ...
      + [Configurar o AEM Forms para obter previamente informações de domínio](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
      ...
      + [Ativar o logon único nos AEM Forms](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
   ...
   + Conexão com um sistema de gerenciamento de conteúdo {#connect-content-management-system}
      ...
      + [Configurando o Connector para IBM Content Manager](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
   ...
   + Gerenciando Endpoints {#manage-endpoints}
   ...
   + Configurar o Acrobat Reader DC Extensions {#configure-acrobat-reader-dc-extensions}
      + [Tipos de certificado usados pelo Acrobat Reader DC Extensions](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
      ...
      + [Configuração do Acrobat Reader DC Extensions para captura de dados](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
      + [Revisar informações de uso de credenciais](/help/forms/using/admin-help/review-credential-information.md)
      + [Configurar credenciais para uso com o Acrobat Reader DC Extensions](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
      + [Revisar os direitos de uso de um arquivo PDF](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
      + [Ativação de comentários online para o plug-in do navegador da Web Adobe Reader](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
      + [Configuração de valores de tempo limite para uso com o Acrobat Reader DC Extensions](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
   ...
   + Configurar formulários {#configure-forms}
      ...
      + [Configuração do armazenamento em cache para formulários](/help/forms/using/admin-help/configuring-caching-forms.md)
      ...
      + [Configuração de locais para formulários](/help/forms/using/admin-help/configuring-locations-forms.md)
   ...
   + Configurar o fluxo de trabalho de formulários{#configure-forms-workflow}
   ...
   + Manutenção de AEM Forms {#maintain-aem-forms}
      ...
      + [Monitoramento de implantações do AEM Forms](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
      + [Gerenciador de trabalho e limitação](/help/forms/using/admin-help/manager-throttling.md)
      + [Execução do AEM Forms no modo de manutenção](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
   + Manutenção do banco de dados de AEM forms {#maintain-aem-forms-database}
   ...
   + Backup e recuperação do AEM Forms {#aem-forms-backup-recovery}
      ...
      + [Backup dos dados do AEM Forms](/help/forms/using/admin-help/backing-aem-forms-data.md)
      + [Arquivos para backup e recuperação](/help/forms/using/admin-help/files-back-recover.md)
      + [Estratégia de backup e recuperação para AEM Forms](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
      ...
      + [Recuperação de dados do AEM Forms](/help/forms/using/admin-help/recovering-aem-forms-data.md)
...
+ Referência do desenvolvedor {#developer-reference}
   + [Noções básicas para desenvolvedor](https://docs.adobe.com/content/help/en/experience-manager-64/developing/home.html)
   ...
   + [AEM Forms na referência da API JEE Java](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/index.html)
   + [APIs Form Bridge para formulários HTML5](using/form-bridge-apis.md)
   + [Referência da API da biblioteca JavaScript para formulários adaptáveis](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
   ...
   + Programação com AEM Forms no JEE {#programming-aem-forms-jee}
      + Introdução à programação com AEM Forms no JEE {#introduction-programming-aem-forms-jee}
         ...
         + [Chamar AEM Forms usando APIs](developing/invoking-aem-forms-using-apis.md)
      ...
      + Início rápido da API Java - Exemplos de código {#java-api-quick-start-code-examples}
         ...
         + [Serviço de extensões do Acrobat Reader DC Início rápido da API Java (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         ...
         + [Converter o QuickStart (SOAP) da API Java do serviço em PDF](developing/convert-pdf-service-java-api.md)
         ...
         + [Gerar o QuickStart (SOAP) da API Java do serviço em PDF](developing/generate-pdf-service-java-api.md)
         ...
         + [Serviço de utilitários PDF Início rápido do Java (SOAP)](developing/pdf-utilities-service-java-api.md)
         ...
         + [Utilitários XMP Serviço Java APIQuick Start (SOAP)](developing/xmp-utilities-service-java-api.md)
      + Chamar AEM Forms no JEE usando APIs {#invoking-aem-forms-jee-apis}
         + [Chamar AEM Forms usando solicitações REST](developing/invoking-aem-forms-using-rest.md)
         + [Chamar AEM Forms usando Remoting](developing/invoking-aem-forms-using-remoting.md)
         + [Chamar AEM Forms usando serviços da Web](developing/invoking-aem-forms-using-web.md)
         + [Chamar AEM Forms usando serviços da Web](developing/invoking-human-centric-long-lived.md)
         + [Chamar AEM Forms usando a JavaAPI](developing/invoking-aem-forms-using-java.md)
      ...
      + Execução de operações de serviço usando APIs {#performing-service-operations-using-apis}
         ...
         + [Formulários de renderização](developing/rendering-forms.md)
         ...
         + [Criando Aplicações Web que Renderiza Formulários](developing/creating-web-applications-renders-forms.md)
         + [Criação de documentos PDF com dados XML enviados](developing/creating-pdf-documents-submitted-xml.md)
         + [Desmontar um documento PDF usando a API do serviço da Web](developing/disassemble-pdf-document-using-web.md)
         ...
         + [Manuseio de formulários enviados](developing/handling-submitted-forms.md)
         ...
         + [Renderizar formulários por valor](developing/rendering-forms-value.md)
         ...
         + [Renderização de formulários HTML usando arquivos CSS personalizados](developing/rendering-html-forms-using-custom.md)
         ...
         + [Renderização de formulários PDF interativos](developing/rendering-interactive-pdf-forms.md)
         + [Renderizar formulários com direitos ativados](developing/rendering-rights-enabled-forms.md)
         + [Validação de documentos DDX](developing/validating-ddx-documents.md)
         + [Conversão de PDF em arquivos Postscript e Imagem](developing/converting-pdf-postscript-image-files.md)
         ...
         + [Criptografar e descriptografar documentos PDF](developing/encrypting-decrypting-pdf-documents.md)

...
Para pesquisar formulários usando a REST API, envie uma solicitação de GET ao servidor com os parâmetros de query descritos abaixo. `https://[server]:[port]/libs/fd/fm/content/manage.json`

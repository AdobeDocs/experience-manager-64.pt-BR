...
1. Na caixa de diálogo de configuração, especifique os detalhes do banco de dados que deseja configurar, como:
   ...
   * Nome de usuário e senha para estabelecer conexão com o driver JDBC
   ...
   >1. No campo **[!UICONTROL Texto sem formatação]**, especifique a senha ou qualquer string a ser criptografada e clique em **[!UICONTROL Protect]**.
...
1. Vá para **[!UICONTROL Ferramentas > Cloud Services > Fontes de dados]**. Toque em para selecionar a pasta na qual deseja criar uma configuração de nuvem.
   ...
   Consulte [Configurar pasta para configurações de serviço em nuvem](/help/forms/using/configure-data-sources.md#cloud-folder) para obter informações sobre como criar e configurar uma pasta para configurações de serviço em nuvem.

...
* Para formulários adaptáveis usando o [modelo de formulário XFA](/help/forms/using/prepopulate-adaptive-form-fields.md), use o preenchimento prévio XML compatível com o schema de dados do modelo XFA.
...
* Para formulários adaptáveis usando [esquema JSON](/help/forms/using/prepopulate-adaptive-form-fields.md#json-schema-based-adaptive-forms), use o preenchimento prévio JSON compatível com o esquema JSON.
* Para formulários adaptáveis usando o esquema FDM, use o esquema de preenchimento prévio JSON compatível com o esquema FDM.
* Para formulários adaptáveis com [nenhum modelo de formulário](/help/forms/using/prepopulate-adaptive-form-fields.md#p-adaptive-form-with-no-form-model-p), não há dados vinculados. Cada campo é um campo não vinculado e é preenchido usando o XML não vinculado.
...
1. Insira o local dos dados ou um regex (expressão regular) para os **[!UICONTROL Data files locations]**. Exemplos de locais de arquivos de dados válidos são:
...
1. No console Propriedades, navegue até **[!UICONTROL AEM Forms container > Basic > Prefill Service]**.

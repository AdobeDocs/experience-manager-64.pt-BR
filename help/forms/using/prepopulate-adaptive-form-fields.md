...
* Para formulários adaptáveis usando o [Modelo de formulário XFA](/help/forms/using/prepopulate-adaptive-form-fields.md), use o XML de preenchimento prévio compatível com o schema de dados do template XFA.
...
* Para formulários adaptáveis usando [Esquema JSON](/help/forms/using/prepopulate-adaptive-form-fields.md#json-schema-based-adaptive-forms), use o pré-preenchimento JSON compatível com o esquema JSON.
* Para formulários adaptáveis usando o esquema FDM, use o esquema de preenchimento prévio JSON compatível com o esquema FDM.
* Para formulários adaptáveis com [sem modelo de formulário](/help/forms/using/prepopulate-adaptive-form-fields.md#p-adaptive-form-with-no-form-model-p), não há dados vinculados. Cada campo é um campo não vinculado e é preenchido usando o XML não vinculado.
...
* **Preencher estrutura XML**: O XML de preenchimento prévio para formulário adaptável baseado em XFA deve ser compatível com o schema de dados do template de formulário XFA. Para preencher previamente campos não vinculados, vincule a estrutura XML de preenchimento prévio em `/afData/afBoundData` .
...
Para formulários adaptáveis com base no esquema JSON, a estrutura do JSON de preenchimento prévio e do JSON enviado é descrita abaixo. Para obter mais informações, consulte [Criação de formulários adaptáveis usando o esquema JSON](/help/forms/using/adaptive-form-json-schema-form-model.md).
...
Para formulários adaptáveis sem modelo de formulário, os dados para todos os campos estão sob o `<data>` tag de `<afUnboundData> tag`.
...
1. Abrir **[!UICONTROL Configuração do Console da Web do Adobe Experience Manager]** usando o URL:\
   https://&lt;server>:&lt;port>/system/console/configMgr
1. Pesquisar e abrir **[!UICONTROL Configuração padrão do serviço de pré-preenchimento]**.

   ![prefill_config](assets/prefill_config.png)

1. Insira o local dos dados ou um regex (expressão regular) para a variável **[!UICONTROL Locais de arquivos de dados]**. Exemplos de locais de arquivos de dados válidos são:
...
* SERVICE_NAME refere-se ao nome do serviço de preenchimento prévio OSGI. Consulte [Criar e executar um serviço de preenchimento prévio](/help/forms/using/prepopulate-adaptive-form-fields.md#create-and-run-a-prefill-service).
...
* [Baixar o SDK do cliente da AEM Forms](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html)
* [Baixe o pacote estereotipado](assets/prefill-sumbit-xmlsandcontentpackage.zip)
...
1. No console Propriedades , navegue até **[!UICONTROL Contêiner do AEM Forms > Básico > Serviço de preenchimento prévio]**.

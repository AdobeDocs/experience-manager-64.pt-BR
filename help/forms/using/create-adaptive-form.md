...
1. Toque em Imagem. A barra de ferramentas é exibida. Toque em ![cmppr](assets/cmppr.png). O navegador de propriedades é aberto à esquerda da tela. **Procure** e carregue a imagem do logotipo. Toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png). A imagem é exibida no cabeçalho.
...
1. Arraste um componente de **email** antes do componente de rodapé. Abra as propriedades do componente, defina os valores listados na tabela abaixo e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).

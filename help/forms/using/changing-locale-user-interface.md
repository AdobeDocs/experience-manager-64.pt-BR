...
Antes de executar as etapas acima, siga as etapas listadas em Etapas [genéricas para personalização](/help/forms/using/generic-steps-html-workspace-customization.md)da área de trabalho do AEM Forms.

>[!NOTE]
>
>Para alterar o idioma da tela de logon da área de trabalho do AEM Forms, consulte [Criar uma nova tela](/help/forms/using/creating-new-login-screen.md)de logon.
...
1. Execute todas as alterações semânticas listadas no artigo Personalização [da](/help/forms/using/introduction-customizing-html-workspace.md) Workspace.

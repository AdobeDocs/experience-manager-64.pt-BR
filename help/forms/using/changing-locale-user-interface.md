...
1. Execute todas as alterações semânticas listadas no [Personalização do Workspace](/help/forms/using/introduction-customizing-html-workspace.md) artigo 10. o

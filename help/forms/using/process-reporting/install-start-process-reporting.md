...
Para obter detalhes sobre os relatórios predefinidos, consulte Relatórios [Relatórios](pre-defined-reports-in-process-reporting.md)predefinidos em andamento.

**Query Ad-hoc:** Este item contém opções para executar pesquisa baseada em filtro para processos e tarefas.

Para obter detalhes sobre query ad-hoc, consulte Query [ad-hoc no Relatórios](adhoc-queries-in-process-reporting.md)Process.

...
O Process Reporting fornece um conjunto de relatórios predefinidos que permitem filtrar, exibir informações sobre processos em execução longa, duração do processo e volume do fluxo de trabalho.

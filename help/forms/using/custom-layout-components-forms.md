...
Conhecimento sobre layouts, que permite criar/usar um layout personalizado. Consulte [Alterar o layout do painel](/help/forms/using/layout-capabilities-adaptive-forms.md).

...
Conhecimento de layouts, que permite criar/usar um layout personalizado. Consulte [Alteração do layout](/help/forms/using/layout-capabilities-adaptive-forms.md)do painel.
...
1. Renomeie o layout para o qual você copiou `customPanelLayout`. Altere as propriedades dos nós `qtip` e `jcr:description`. Por exemplo, mude para `Custom layout - Toggle tabs`.

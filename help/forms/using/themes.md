...
1. Clique em **[!UICONTROL Criar]** e em **[!UICONTROL Editar]** para abrir o tema no Editor de Temas ou clique em **[!UICONTROL Concluído]** para voltar à página de temas.
...
1. Na página Temas , selecione um tema e clique em **[!UICONTROL Download]**. Uma caixa de diálogo com os detalhes do tema é exibida.
...
* **Barra lateral** - Aparece no lado esquerdo. Ela tem os seguintes itens:
   ...
   * **Exibir CSS**: Permite que você visualize o CSS do componente selecionado
   ...
   Além disso, na Barra lateral, na parte inferior, uma seta está presente. Ao clicar na seta, você terá mais duas opções: **Simular Êxito** e **Simular Erro.** Essas opções, juntamente com as opções descritas acima, são discutidas detalhadamente  [abaixo](/help/forms/using/themes.md#using-rail).
...
1. Na caixa de diálogo Gerenciar estilos, selecione um estilo salvo, clique em **[!UICONTROL Excluir]**.
...
1. No painel EDITOR DE TEMAS, clique em **[!UICONTROL Opções de Temas]** ![opções de tema](assets/theme-options.png) **[!UICONTROL Configurar]**.

1. Na guia General , navegue e selecione um formulário ou comunicação interativa para o campo **[!UICONTROL Adaptive Form/Document]**.
...
O Editor de Temas permite que você edite um tema que você criou ou carregou. Navegue até **[!UICONTROL Forms &amp; Documents > Themes]**, selecione um tema e o abra. O tema é aberto no Editor de Temas.
...
* **[!UICONTROL Opções de Temas]** ![Opções de Temas](assets/theme-options.png): Fornece três opções
...
1. O título da barra lateral muda para o Widget de caixa numérica e mostra opções para personalizar sua aparência.
   ...
   Use a opção **[!UICONTROL Dimension e Position]** na barra lateral para personalizar o tamanho do componente. Certifique-se de que o Estado seja **[!UICONTROL Padrão]**.
...
Agora é possível usar fontes disponíveis em um serviço da Web em um formulário adaptável ou comunicação interativa. Pronto para uso, [Typekit](https://typekit.com/), serviço de fonte Web Adobe, está disponível como uma configuração. Para usar o Typekit, crie um kit e fontes nele, e obtenha a ID do Kit do [site do Typekit](https://typekit.com/).
...
1. Na página **[!UICONTROL Cloud Services]**, navegue até **[!UICONTROL Serviços de terceiros]** > **[!UICONTROL Typekit]** e clique em **[!UICONTROL Configurar agora]** em Typekit. Se uma configuração já estiver disponível, clique no botão **+** para criar uma nova instância.
...
1. No editor de temas, navegue até **[!UICONTROL Opções de Temas]** ![theme-options](assets/theme-options.png) > **[!UICONTROL Configurar]**.
1. No campo **[!UICONTROL Typekit Configuration]**, selecione um kit e clique em **[!UICONTROL Save]**.
...
1. Abra **[!UICONTROL Serviço de Configuração de Tema de Formulário Adaptativo]**.
...
1. No modo de edição, selecione um componente, em seguida, clique em ![nível de campo](assets/field-level.png) > **[!UICONTROL Contêiner de formulário adaptável]** e clique em ![cmppr](assets/cmppr.png).

   É possível editar as propriedades do formulário na barra lateral.

1. Na barra lateral, clique em **[!UICONTROL Estilo]**.
1. Selecione o tema no menu suspenso **[!UICONTROL Adaptive Form Theme]** e clique em **[!UICONTROL done]** ![check-button](assets/check-button.png).
...
1. No modo de edição, selecione um componente, em seguida, clique em ![nível de campo](assets/field-level.png) >**[!UICONTROL Contêiner de documento]** e clique em ![cmppr](assets/cmppr.png).

   É possível editar as propriedades do formulário na barra lateral.

1. Na barra lateral, em **[!UICONTROL Básico]**, selecione seu tema no menu suspenso **[!UICONTROL Tema]** e clique em **[!UICONTROL Concluído]** ![botão de seleção](assets/check-button.png).
...
* **Evitar ativos de outro Tema**
   ...
   Ao editar um tema, você pode procurar e adicionar ativos (como imagens) de outros temas. Por exemplo, você está editando o plano de fundo de uma página. Por exemplo, ao selecionar **[!UICONTROL Page]** ![edit-button](assets/edit-button.png) **[!UICONTROL Background > Add > Image]**, você verá uma caixa de diálogo que permite procurar e adicionar imagens em outro tema.
...
* **Uso da clientlib base, do editor de temas e do estilo em linha**
   ...
   * **Estilo em linha:**
      ...
      É possível criar estilos de componentes usando o modo Estilo no formulário ou o editor multicanal de comunicação interativo ao trabalhar com um formulário. Usar o modo de estilo para alterar o estilo do componente de formulário substitui o estilo especificado no tema. Se quiser alterar o estilo de determinados componentes de um formulário específico, consulte [Estilo em linha de componentes](/help/forms/using/inline-style-adaptive-forms.md).

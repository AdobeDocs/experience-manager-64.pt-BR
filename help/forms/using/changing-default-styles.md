...
1. **Escolha um perfil para adicionar estilos personalizados**
   ...
   Acesse a interface CRX DE no URL: **https://&lt;server>:&lt;port>/crx/de** e crie um perfil ou escolha um perfil existente. Para saber como criar um perfil, consulte [Criar um novo Perfil](/help/forms/using/custom-profile.md)

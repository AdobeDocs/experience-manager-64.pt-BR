...
Você pode incorporar um fragmento de formulário adaptável em um formulário adaptável clicando em **[!UICONTROL Incorporar ativo:*fragmentName *]**na barra de ferramentas do painel do fragmento adicionado, como mostrado na imagem de exemplo a seguir.

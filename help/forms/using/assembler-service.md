...
Usar o DDX e o serviço Assembler para chamar outros serviços do LiveC ycle pode simplificar seu diagrama de processo. Ele pode até reduzir o esforço gasto na personalização de seus fluxos de trabalho. (Consulte também [Uso do AEM Document Services Programaticamente](https://helpx.adobe.com/experience-manager/6-4/forms/using/aem-document-services-programmatically.html))

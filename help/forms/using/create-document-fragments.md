...
Use **FDM_Create_First_IC**, conforme descrito na seção [Criar modelo de dados de formulário](create-form-data-model-tutorial.md), como o modelo de dados de formulário para criar fragmentos de documento neste tutorial.

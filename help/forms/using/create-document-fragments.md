...
* [Detalhes da fatura](/help/forms/using/create-document-fragments.md#step-create-bill-details-text-document-fragment)
...
* [Resumo dos encargos](/help/forms/using/create-document-fragments.md#step-create-summary-of-charges-text-document-fragment)
...
Use **FDM_Create_First_IC**, conforme descrito no [Criar modelo de dados de formulário](create-form-data-model-tutorial.md) , como o modelo de dados de formulário para criar fragmentos de documento neste tutorial.
...
1. Coloque o cursor próximo à **Número de Contato Alternativo** e clique duas vezes no **cliente** > **alternatemobilenumber** propriedade.

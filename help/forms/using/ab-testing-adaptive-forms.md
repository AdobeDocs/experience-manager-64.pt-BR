...
1. Na página Criar novo público-alvo , crie regras. As regras permitem categorizar o público-alvo. Por exemplo, você deseja categorizar os públicos-alvo com base no sistema operacional. Seu público-alvo A vem do Windows e o público-alvo B vem do Linux.
   ...
   * Para categorizar o público-alvo com base no Windows, na Regra 1, selecione **SO** tipo de atributo. Na lista suspensa Quando , selecione **Windows**.
   * Para categorizar o público-alvo com base no Linux, na Regra 2, selecione **SO** tipo de atributo. Na lista suspensa Quando , selecione **Linux** e clique em **Próximo**.

...
1. Na página Criar novo público-alvo, crie regras. As regras permitem categorizar o público-alvo. Por exemplo, você deseja categorizar os públicos com base no sistema operacional. Seu público-alvo A vem do Windows, e o público B vem do Linux.
   ...
   * Para categorizar o público-alvo com base no Windows, na Regra nº 1, selecione o tipo de atributo **OS** . Na lista suspensa Quando, selecione **Windows**.
   * Para categorizar o público-alvo com base no Linux, na Regra nº 2, selecione o tipo de atributo do **SO** . Na lista suspensa Quando, selecione **Linux** e clique em **Avançar**.

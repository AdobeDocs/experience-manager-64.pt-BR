...
Se a instância AEM estiver sendo executada em JBoss, iniciada como um serviço de chave-na-mão, no `jboss\bin\standalone.conf.bat` arquivo, adicione o parâmetro -Dabtesting.enabled=true na seguinte entrada:

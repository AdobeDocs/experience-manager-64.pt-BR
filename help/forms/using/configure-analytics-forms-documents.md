...
# Configuração de relatórios e análises {#configuring-analytics-and-reports}
...
1. Clique em **Forms > Forms e Documentos**, selecione um formulário ou documento e clique em **Ativar o Analytics**. A análise está ativada.
   ...
   **A.** Ativar botão do Analytics  **B.Formulário** selecionado
   ...
   Para obter informações detalhadas sobre como visualizar relatórios de análise de formulários, consulte [Visualizar e entender relatórios de análise do AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md)

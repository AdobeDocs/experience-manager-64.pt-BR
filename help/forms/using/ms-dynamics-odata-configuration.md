...
* Instalado o [AEM 6.4 pacote de complementos Forms](https://helpx.adobe.com//experience-manager/6-4/forms/using/installing-configuring-aem-forms-osgi.html)
...
* [Registrado o aplicativo do serviço online Microsoft Dynamics com o Microsoft Azure Ative Diretory](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/developer/walkthrough-register-dynamics-365-app-azure-active-directory). Anote os valores para a ID do cliente (também chamada de ID da aplicação) e o segredo do cliente para o serviço registrado. Esses valores são usados ao [configurar o serviço em nuvem para o serviço do Microsoft Dynamics](/help/forms/using/ms-dynamics-odata-configuration.md#configure-cloud-service-for-your-microsoft-dynamics-service).
...
1. Vá para a conta do Ative Diretory do Microsoft Azure e adicione o seguinte URL de configuração de serviço em nuvem nas configurações **[!UICONTROL URLs de resposta]** para o aplicativo registrado:
...
1. Selecione **[!UICONTROL Cloud Service do MS Dynamics OData (Serviço OData)]** a configuração e toque em **[!UICONTROL Propriedades]**. A caixa de diálogo de propriedade de configuração do serviço de nuvem é aberta.

   Na guia **[!UICONTROL Configurações de autenticação]**:

   1. Digite o valor para o campo **[!UICONTROL Raiz do Serviço]**. Vá para a instância do Dynamics e navegue até **[!UICONTROL Developer Resources]** para visualização do valor do campo Service Root. Por exemplo, https://&lt;nome-locatário>/api/data/v9.1/
   1. Substitua os valores padrão no **[!UICONTROL ID do cliente]** (também conhecido como **[!UICONTROL ID da aplicação]**), **[!UICONTROL Segredo do cliente]**, **[!UICONTROL URL OAuth]**, **[!UICONTROL Atualizar URL do token]**, **[!UICONTROL URL do Token de acesso&lt;a 11/> e os campos**[!UICONTROL  Resource ]**com valores da configuração do serviço Microsoft Dynamics.]** É obrigatório especificar o URL da instância dinâmica no campo **[!UICONTROL Recurso]** para configurar o Microsoft Dynamics com um modelo de dados de formulário. Use o URL raiz do serviço para derivar o URL da instância dinâmica. Por exemplo, [https://org.crm.dynamics.com](https://org.crm.dynamics.com/).
...
Para revisar o modelo de dados de formulário, vá para **[!UICONTROL Forms > Integrações de dados]**. Selecione **[!UICONTROL FDM do Microsoft Dynamics]** e clique em **[!UICONTROL Editar]** para abrir o modelo de dados de formulário no modo de edição. Como alternativa, você pode abrir o modelo de dados de formulário diretamente do seguinte URL:
...
Para obter mais informações sobre como criar e usar o modelo de dados de formulário em workflows de negócios, consulte [Integração de dados](/help/forms/using/data-integration.md).

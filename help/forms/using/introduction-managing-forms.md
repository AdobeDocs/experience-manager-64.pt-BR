...
* **** Publicar ativos de gerenciamento de correspondência: O AEM Forms permite publicar todas as Cartas, Fragmentos de documento e Dicionários de dados e dependências relacionadas de uma instância do autor ao mesmo tempo. Os ativos publicados incluem todos os ativos do Gerenciamento de Correspondência e dependências relacionadas. Para obter informações detalhadas, consulte [Publicação e cancelamento da publicação de formulários e documentos](/help/forms/using/publishing-unpublishing-forms.md#publishallthecorrespondencemanagementassets).
...
* **** Trilho esquerdo: Você pode clicar no ícone do painel esquerdo ![railleftpng](assets/railleftpng.png) para revelar os recursos Linha do tempo e Referências do AEM Forms.
   ...
   * **** Linha do tempo: Você pode adicionar e exibir comentários em um ativo que está disponível para revisão na linha do tempo. Para obter instruções detalhadas, consulte [Criar e gerenciar revisões de ativos em formulários](/help/forms/using/create-reviews-forms.md).
...
* **** Comutador de visualização: Você pode clicar no ícone Visualizar comutador ![na lista](assets/viewlist.png) de exibição ou no ![cartão](assets/viewcard.png) para alternar rapidamente entre a lista e a exibição do cartão. Para obter mais informações sobre componentes comuns da interface do usuário, consulte [Trabalhar com o ambiente](/help/sites-authoring/basic-handling.md)de criação.

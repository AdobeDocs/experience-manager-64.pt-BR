...
![Componentes do portal do AEM Forms no ](assets/component-categories.png)
**navegador de componentesFigura:** *Categorias de componentes do portal do Forms*
...
![Painel Lista no ](assets/edit-list.png)
**modo de ediçãoFigura:** *Painel Lista no modo de edição*

A caixa de diálogo **[!UICONTROL Editar]** inclui várias guias que fornecem opções de configuração descritas na tabela abaixo. Toque em **[!UICONTROL OK]** para salvar a configuração, quando concluído.
...
![Painel de pesquisa com data, texto completo, propriedades e ](assets/search-with-predicates.png)
**predicado de tagsFigura:** *Painel de pesquisa com preditivo de data, texto completo, propriedades e tags*
...
1. Especifique o seguinte:
   ...
   * **[!UICONTROL Tipo:]** a única opção disponível é Data da  **[!UICONTROL última modificação]**.
   ...
   * **[!UICONTROL Rótulo da data inicial:]** Rótulo ou legenda do campo da data inicial.
...
1. Na guia **[!UICONTROL General]**, especifique o rótulo de pesquisa. O valor padrão é **[!UICONTROL Properties]**.

1. Na guia **[!UICONTROL Options]**, toque em **[!UICONTROL Add Item]**.
...
Para vincular um formulário de qualquer lugar na página, use o componente Link . Para obter mais informações sobre o componente de link, consulte [Incorporando componente de link em uma página](/help/forms/using/embedding-link-component-page.md).

Para listar os formulários que estão em um estado de rascunho e os formulários que já foram enviados, use o componente **[!UICONTROL Rascunhos e envios]**. Para obter mais informações, consulte [Personalizando componente Rascunhos e Envios](/help/forms/using/draft-submission-component.md).
...
**componente Pesquisa e listerFigura: componente** *Pesquisa e lister*
...
Pronto para uso, o portal de formulários fornece ações de renderização. Você pode personalizar o portal de formulários para adicionar mais ações. Para obter informações detalhadas, consulte [Adicionar ação personalizada aos itens do lister de formulários.](/help/forms/using/add-custom-action-form-lister.md)

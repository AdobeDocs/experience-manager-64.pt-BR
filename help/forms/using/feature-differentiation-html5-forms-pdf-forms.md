...
Siga as práticas recomendadas para ativar um modelo de formulário para representações HTML5 e garantir que o comportamento e a aparência de formulários HTML5 e PDF baseado em XFA sejam consistentes. Para obter uma lista detalhada das práticas recomendadas, consulte [Práticas recomendadas para criar um formulário HTML5.](/help/forms/using/best-practices-for-html5-forms.md)

...
![Tela inicial do aplicativo FormsClique para ampliar ](assets/home-screen-1.png)
...
Você pode alterar a tela inicial padrão do aplicativo a partir das **[Configurações gerais](/help/forms/using/update-general-settings.md)** do aplicativo, ou da guia **Preferência** no espaço de trabalho HTML.

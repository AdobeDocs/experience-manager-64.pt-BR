...
1. Clique com o botão direito do mouse no nó de teste (aqui **afTestRegistration)** e clique em **[!UICONTROL Criar > Criar arquivo]**. Nomeie o arquivo js.txt e clique em **[!UICONTROL OK]**.
...
1. Clique com o botão direito do mouse no nó de teste (aqui **afTestRegistration)** e clique em **[!UICONTROL Criar > Criar arquivo]**. Nomeie o arquivo init.js e clique em **[!UICONTROL OK]**.

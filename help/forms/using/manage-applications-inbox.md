...
### Tarefas de solicitação ou delegada {#claim-or-delegate-tasks}
...
1. Faça uma das seguintes opções:
   ...
   * Para delegar a tarefa, toque em **[!UICONTROL Delegar]**. A caixa de diálogo Delegar item é aberta. Selecione um usuário, adicione opcionalmente um comentário e toque em **[!UICONTROL OK]**.
...
1. Toque em **[!UICONTROL Abrir]** para visualização dos detalhes da tarefa e realizar ações. A visualização detalhada da tarefa é aberta. Nesta visualização, você pode visualização detalhes da tarefa e realizar ações na tarefa.
...
A seção Detalhes da Tarefa exibe informações sobre a tarefa. As informações exibidas dependem das configurações de [Atribuir etapa de tarefa](/help/sites-developing/workflows-step-ref.md) no fluxo de trabalho. O exemplo acima exibe a descrição, o status, a data do start e o fluxo de trabalho usados para a tarefa. Também permite anexar um arquivo à tarefa.
...
Além disso, a guia exibe o histórico de tarefas para cada estágio concluído no fluxo de trabalho. Você pode tocar em **[!UICONTROL Detalhes da Visualização]** para obter informações detalhadas sobre o estágio. Ele exibe comentários, anexos de formulário e tarefa, status, datas de start e término e assim por diante sobre a tarefa.
...
### Tarefas concluídas pela visualização {#view-completed-tasks}
...
1. Na AEM Caixa de entrada, toque em ![alternar o painel lateral1](assets/toggle-side-panel1.png) para abrir o seletor de filtro.
1. Toque em **[!UICONTROL Status da Tarefa]** e selecione **[!UICONTROL Concluir]**. Todas as tarefas concluídas são exibidas.

   ![filter-1](assets/filter-1.png)

1. Toque para selecionar uma tarefa e clique em **[!UICONTROL Abrir]**.

A tarefa é aberta para exibir o documento ou o formulário adaptável associado à tarefa. Para o formulário adaptável, ele exibe o formulário adaptativo somente leitura ou seu documento PDF de registro, conforme configurado na guia Formulário/Documento da [Etapa de fluxo de trabalho Atribuir Tarefa](/help/sites-developing/workflows-step-ref.md).
...
A guia **[!UICONTROL Detalhes do fluxo de trabalho]** mostra cada etapa do fluxo de trabalho. Toque em **[!UICONTROL Detalhes da Visualização]** para obter uma etapa para obter informações detalhadas.

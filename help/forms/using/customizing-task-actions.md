...
* Encapsule a tag do ícone dentro da tag de âncora em vez do texto. Por exemplo, o *novo código *listado abaixo encapsula a tag de ícone dentro da tag de âncora:

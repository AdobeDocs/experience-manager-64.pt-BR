...
Use a interface [do usuário do](/help/forms/using/introduction-managing-forms.md) AEM Forms para gerenciar todos os formulários, conjuntos de formulários e ativos relacionados.

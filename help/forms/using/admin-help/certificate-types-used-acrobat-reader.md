...
seo-title: 'Tipos de certificado usados pelas extensões do Acrobat Reader DC '
...
**** Tipo de certificado: Descreve os módulos de formulários do AEM ativados pelo certificado e o nível de ativação, como o Código de barras 2D ARE Cheio. Para obter uma lista dos tipos de certificados disponíveis, consulte a coluna Tipo na tabela da seção Perfis de certificados.
...
**** Versão de direitos de uso: Descreve a versão do algoritmo de direitos de uso para a qual o certificado pode ser usado, como V6.1. Esta versão não significa a versão das extensões do Acrobat ou do Acrobat Reader DC.

**** Código do perfil: O código do perfil é uma descrição resumida das propriedades completas do certificado, como P8, por exemplo. Para obter uma lista dos códigos de perfil associados a cada tipo de arquivo, consulte a coluna Código de perfil na tabela da seção Perfis de certificado.

**** Número de série: Um número de série é atribuído a cada certificado emitido pela Adobe, como 0002054. O suporte empresarial da Adobe ou um representante de conta da Adobe Enterprise pode usar esse número de série para rastrear o certificado em um pedido de produto específico ou em uma relação OEM.

## Perfis de certificado {#certificate-profiles}

A tabela a seguir lista os perfis de certificado que podem ser encontrados ao analisar os certificados de extensões do Acrobat Reader DC.
...
<table> 
 ...
 <tbody>
  ...
  <tr> 
   <td><p>P8</p></td> 
   <td><p>Formulários, produção</p></td> 
   <td><p>Máximo</p></td> 
   <td><p>Produção</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td><p>I10</p></td> 
   <td><p>Formulários; podem ser usados por OEMs</p></td> 
   <td><p>Máximo</p></td> 
...
Os certificados de Integração de Parceiros são emitidos para parceiros comerciais da Adobe para suportar desenvolvimento, integração, protótipo e demonstração de software. Estes certificados são válidos por dois anos a contar da data da sua emissão.

Os certificados de uso interno da Adobe são usados na Adobe para suportar desenvolvimento, integração, protótipo e demonstração de software. Estes certificados são válidos por dois anos a contar da data da sua emissão.

Os certificados de produção são emitidos para clientes que compraram extensões do Acrobat Reader DC. Esses certificados são válidos pelo período máximo permitido pela autoridade de certificação (CA), mostrado como *Max* na tabela Perfis de certificado.
...
<table> 
 ...
 <tbody>
  ...
  <tr> 
   ...
   <td><p>Crie e modifique anotações do documento, como comentários.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>Imprima um documento com códigos de barras de dados de formulário em um formulário não criptografado que não exija que o software de servidor licenciado decodifice.</p></td> 
  </tr> 
  <tr> 
   <td><p>AnnotOnline</p></td> 
   <td><p>Carregue e baixe anotações, como comentários, de e para um servidor de comentários e revisão de documentos online.</p></td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>Os direitos de uso de extensões do Acrobat Reader DC podem ser licenciados da Adobe somente em determinadas combinações que funcionam juntas. Não é possível licenciar esses recursos independentemente. Para obter informações sobre as combinações disponíveis de direitos de uso, entre em contato com um representante de conta de formulários AEM.

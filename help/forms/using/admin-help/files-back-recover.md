...
O local padrão do diretório raiz do Armazenamento de conteúdo é *[aem-forms raiz]*/lccs_data.
...
>[!NOTE]
>
>Por padrão, as fontes Adobe instaladas com formulários AEM estão localizadas no diretório [aem-forms raiz]/fonts.

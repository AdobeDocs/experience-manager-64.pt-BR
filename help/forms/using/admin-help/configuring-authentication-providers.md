...
1. Clique em um domínio existente na lista. Se você estiver adicionando autenticação para um novo domínio, consulte [Adicionar um domínio](/help/forms/using/admin-help/adding-domains.md#add-an-enterprise-domain) empresarial ou [Adicionar um domínio](/help/forms/using/admin-help/adding-domains.md#add-a-hybrid-domain)híbrido.
...
1. Grave um contêiner de serviço que implemente as interfaces IdentityCreator e AssignmentProvider. (Consulte [Programação com formulários](https://www.adobe.com/go/learn_aemforms_programming_63)AEM.)

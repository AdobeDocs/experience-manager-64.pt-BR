...
Para obter detalhes sobre as várias funções de segurança do documento, consulte [Sobre usuários de segurança do documento](/help/forms/using/admin-help/document-security.md#about-document-security-users).
...
* Os coordenadores de conjunto de políticas podem editar políticas em conjuntos de políticas somente se tiverem as permissões corretas. O superusuário ou administrador do conjunto de políticas define essas permissões na interface do administrador de segurança do documento.
...
* O documento inteiro, incluindo seus anexos e metadados. *Os* metadados contêm informações sobre o documento e seu conteúdo que podem ser visualizações na caixa de diálogo Propriedades do documento ou no menu Avançado do Acrobat. No Acrobat, é possível anexar arquivos de tipos diferentes (por exemplo, arquivos de texto, áudio e vídeo) a documentos PDF.
...
## Procurar por políticas {#search-for-policies}
...
1. Para pesquisar por uma política compartilhada, clique em Políticas e, em seguida, clique na guia Conjuntos de políticas. Clique em um conjunto de políticas na lista e clique na guia Políticas.

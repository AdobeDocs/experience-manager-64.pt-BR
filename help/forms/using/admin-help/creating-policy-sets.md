...
1. (Opcional) Para definir os domínios que estão visíveis para os Editor de documentos quando eles adicionam usuários a uma política, clique em Adicionar domínios, selecione os domínios que podem ser pesquisados, clique em Adicionar e em OK.
...
1. Para excluir um usuário ou grupo visível, Coordenador do conjunto de políticas ou Editor de documentos, clique na guia apropriada, marque a caixa de seleção da entrada, clique em Excluir e clique em OK.

...
Os aplicativos cliente devem ser configurados para se conectar à segurança do documento para proteger documentos, abrir documentos protegidos por política e se conectar às páginas da Web de segurança do documento. Consulte a Ajuda *da* Acrobat ou a Ajuda *adequada* do RightsManagementExtension para obter informações sobre como configurar a conexão no aplicativo cliente.

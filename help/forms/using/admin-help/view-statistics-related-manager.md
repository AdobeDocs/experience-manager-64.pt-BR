...
### Status (somente para categoria do Gerenciador de tarefas) {#status-for-job-manager-category-only}
...
Selecione uma opção neste filtro para mostrar apenas os itens de trabalho que foram criados dentro do período de tempo selecionado. Por exemplo, selecionar 1 dia exibe todos os itens de trabalho criados dentro de 24 horas antes da hora definida no filtro Antes.
...
1. Use as ferramentas de operação descritas abaixo para gerenciar os itens de trabalho ou as tarefas na lista.
   ...
   **Repetir itens:** Tenta executar novamente o item de trabalho ou o trabalho selecionado a partir do seu estado atual.

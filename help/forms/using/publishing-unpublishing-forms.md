...
A AEM Forms permite que você crie, publique e cancele a publicação de formulários facilmente. Para obter mais informações sobre o AEM Forms, consulte [Introdução ao gerenciamento de formulários](/help/forms/using/introduction-managing-forms.md).

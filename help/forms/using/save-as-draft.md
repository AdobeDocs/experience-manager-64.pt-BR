...
Para configurar o envio de formulários adaptáveis, consulte [Rascunhos e componentes](/help/forms/using/draft-submission-component.md)enviados. (Não é válido para formulários sincronizados com o servidor AEM Forms JEE.)
...
1. No aplicativo AEM Forms, navegue até o **Forms.**

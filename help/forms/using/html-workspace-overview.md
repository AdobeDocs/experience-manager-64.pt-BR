...
# Trabalhar com o espaço de trabalho AEM Forms {#working-with-aem-forms-workspace}
...
### Limitações do espaço de trabalho AEM Forms {#limitations-of-aem-forms-workspace}
...
O artigo [customization](introduction-customizing-html-workspace.md) explica os tipos de tais personalizações.

...
1. Categoria
   ...
   As categorias estão presentes na guia Iniciar processo da área de trabalho. Essas categorias são usadas para classificar os pontos iniciais.
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>T</td> 
   <td>Contém uma lista de todos os pontos iniciais presentes em uma categoria</td> 
  </tr>
  <tr>
   <td>categoryList</td> 
   <td>T</td> 
...
1. Ponto de partida
   ...
   O ponto inicial é usado para iniciar um processo a partir do espaço de trabalho quando chamado.
   ...
   | isFavorite | T | Indica se o ponto de partida é favorito ou não. Verdadeiro se o ponto de partida for o favorito senão falso. |
...
1. Tarefa
   ...
   As tarefas são atribuídas a usuários/grupos e incluem uma interface do usuário — um formulário ou um Guia (obsoleto) — que pode ser preenchido com dados. Quando uma tarefa é atribuída aos usuários, eles recebem o formulário ou o Guia para preencher e enviar.
...
<table> 
 <tbody>
  ...
  <tr>
   <td>classOfTask</td> 
   <td>F</td> 
   <td>A classe de tarefa é 'LC8' quando a tarefa é lc8 e não é 'Standard'.<br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>F</td> 
   <td>True se o formulário de tarefa precisar ser aberto para concluir a tarefa.<br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   <td>priority<br /> </td> 
   <td>F</td> 
   <td>Contém prioridade de tarefa.<br /> 1 = Prioridade<br /> mais alta 2 = Prioridade<br /> alta 3 = Prioridade<br /> normal 4 = Prioridade<br /> baixa 5 = Prioridade mais baixa<br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   <td>routeList<br /> </td> 
   <td>F</td> 
   <td>Contém uma lista de rotas associadas à tarefa. O usuário pode concluir a tarefa selecionando qualquer uma das rotas da lista de rotas.<br /> </td> 
  </tr>
  <tr>
   <td>seletedRoute<br /> </td> 
   <td>F</td> 
   <td>Ele contém o nome do roteiro selecionado quando a tarefa foi concluída.<br /> </td> 
  </tr>
  <tr>
   <td>serializedImageTicket<br /> </td> 
   <td>F</td> 
   <td>Ele contém o ticket de imagem correspondente à tarefa. <br /> Esse ticket de imagem é usado no campo de tarefa imageUrl, para obter a imagem da tarefa do servidor. <br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   <td>status<br /> </td> 
   <td>F</td> 
   <td>1 = Criada (a tarefa é criada a partir do ponto inicial.)<br /> 2 = Criada e salva (a tarefa é criada a partir do ponto inicial e salva.)<br /> 3 = Atribuída (a tarefa é atribuída ao usuário depois que o processo é iniciado.)<br /> 4 = Atribuído e salvo (a tarefa é atribuída e salva.)<br /> 100 = Concluído (Tarefa concluída.)<br /> 101 = Adiado (a tarefa atingiu o prazo.)<br /> 102 = Terminado<br /> </td> 
  </tr>
  <tr>
   <td>stepName<br /> </td> 
   <td>F</td> 
  ...
  <tr>
   <td>updateTime<br /> </td> 
   <td>F</td> 
   <td>Carimbo de data e hora em que a tarefa foi atualizada pela última vez.<br /> </td> 
  </tr>
  <tr>
   <td>formUrl<br /> </td> 
   <td>T</td> 
  ...
  <tr>
   ...
   <td>T</td> 
   <td>Ele contém uma lista de tarefas usadas na guia Histórico de detalhes da tarefa.<br /> </td> 
  </tr>
  <tr>
   <td>isOwner<br /> </td> 
   <td>T</td> 
  ...
  <tr>
   ...
   <td>T</td> 
   <td>Contém todas as ações que podem ser realizadas na tarefa.<br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>T</td> 
   <td>Ele contém uma lista de tarefas pendentes para a instância do processo da tarefa.<br /> </td> 
  </tr>
  <tr>
...
1. Filtro
   ...
   O filtro é basicamente uma fila de usuários ou grupos. Quando uma tarefa é atribuída ao usuário/grupo, ela é adicionada à fila correspondente.
...
<table> 
 <tbody>
  ...
  <tr>
   <td>query</td> 
   <td>T</td> 
   <td>Isso contém consulta associada a um filtro. Esta consulta é usada para pesquisar tarefas a partir da lista de tarefas completa.<br type="_moz" /> </td> 
  </tr>
  <tr>
   <td>tarefas</td> 
   <td>T</td> 
...
1. Fora do escritório
   ...
   Você pode gerenciar sua programação fora do escritório e controlar o fluxo de tarefas atribuídas a você na ausência.
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>F</td> 
   <td>Ele contém objetos de matriz de agendamentos esgotados de um usuário. Em cada objeto de programação, o campo startDate contém a data inicial e o campo endDate da programação contém a data final da programação. Se endDate for nulo na programação, isso implica que o usuário não programou a data final da programação fora do escritório.<br type="_moz" /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>T</td> 
   <td>Contém uma lista de usuários que são pesquisados pelo usuário conectado até a data.<br type="_moz" /> </td> 
  </tr>
 </tbody>
</table>
...
1. Objeto de Atribuição de Tarefa
   ...
   O objeto de atribuição de tarefa contém informações sobre a atribuição de tarefa. Veja a seguir as propriedades da atribuição da tarefa.
...
1. Objeto ACL da tarefa
   ...
   O objeto ACL de tarefa contém informações sobre permissões como encaminhar, compartilhar, consultar etc. de uma tarefa. Veja a seguir as propriedades da ACL da tarefa.
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>F</td> 
   <td>Lista de grupos de usuários.<br type="_moz" /> </td> 
  </tr>
  <tr>

...
Depois de criar e ativar um modelo, ele estará disponível no gerenciador de formulários ao criar um formulário adaptável. Para usar um modelo e criar um formulário adaptável, consulte [Criação de um formulário](/help/forms/using/creating-adaptive-form.md)adaptável.
...
1. Localize e abra as configurações **[!UICONTROL do]** FormsManager:
   ...
   * Para mostrar ou ocultar modelos de formulário adaptáveis que foram adicionados AEM versões 6.0 Forms ou AEM 6.1 Forms mas que agora estão obsoletos, marque ou desmarque a opção **Incluir AEM 6.0 modelos** AF. Se essa opção estiver marcada, para entrar em vigor, será necessário ativar a configuração **[!UICONTROL Incluir fora da caixa AF e Modelos]** AD para que ela seja ativada.

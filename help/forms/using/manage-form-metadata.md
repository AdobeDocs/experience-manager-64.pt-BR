...
Se você for um desenvolvedor ou proprietário de um site, poderá personalizar o Portal do Forms , a interface do usuário final do AEM Forms , para refletir os metadados que você está usando em sua organização. Para obter mais informações sobre o Portal de formulários, consulte [Introdução à publicação de formulários em um portal](/help/forms/using/introduction-publishing-forms.md).
...
## Exibir metadados do formulário {#view-form-metadata-nbsp}
...
### Adicionar propriedade de metadados personalizados no editor de esquema {#add-custom-metadata-property-in-schema-editor-nbsp}

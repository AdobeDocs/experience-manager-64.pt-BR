...
1. Configure o serviço de nuvem para reCAPTCHA.
   ...
   1. Na instância do autor AEM, vá para ![tools](assets/tools.png) > **Cloud Services**.
...
1. No menu suspenso **[!UICONTROL Captcha service]**, selecione **[!UICONTROL reCaptcha]** para ativar o serviço reCAPTCHA se você o configurou conforme descrito em [ReCAPTCHA service do Google](#google-recaptcha). Selecione uma configuração no menu suspenso Configurações. Além disso, selecione o tamanho como **[!UICONTROL Normal]** ou **[!UICONTROL Compacto]** para o widget reCAPTCHA.

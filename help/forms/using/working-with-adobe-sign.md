...
Ative workflows de assinatura eletrônica (Adobe Sign) para um formulário adaptável para automatizar workflows de assinatura, simplificar processos de assinatura única e múltipla e assinar eletronicamente formulários de dispositivos móveis.
...
* Verifique se o serviço de nuvem da AEM Forms está configurado para usar o Adobe Sign. Para obter detalhes, consulte [Integrar o Adobe Sign ao AEM Forms](/help/forms/using/adobe-sign-integration-adaptive-forms.md).
* Mantenha a lista dos signatários prontos. Você precisa de pelo menos um endereço de email para cada assinante.

## Configure o Adobe Sign para um formulário adaptável {#configure-adobe-sign-for-an-adaptive-form}
...
1. [Habilitar Adobe Sign para um formulário adaptável](#enableadobsignforanadaptiveform)
1. [Selecione o Cloud Service Adobe Sign para um formulário adaptável](#selectadobesigncloudserviceforanadaptiveform)
...
Execute as seguintes etapas para criar um formulário adaptável para Adobe Sign:
...
1. Na guia **[!UICONTROL Basic]**:
   ...
   1. Especifique **Name** e **Title** para o formulário adaptável.
   1. Selecione o [container de configuração](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) criado ao configurar o Adobe Sign com o AEM Forms.
...
1. Na guia **[!UICONTROL Basic]**, selecione o [container de configuração](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) criado ao configurar o Adobe Sign com o AEM Forms.
1. Na guia **[!UICONTROL Modelo de formulário]**, selecione uma das seguintes opções:
...
1. Arraste e solte o componente **Adobe Sign Block** do navegador de componentes para o formulário adaptável. O componente Adobe Sign Block tem todos os campos do Adobe Sign suportados. Por padrão, adiciona um campo **Signature** ao formulário adaptável.
...
1. Selecione o componente **Adobe Sign Block** e toque no ícone **Editar** ![aem_6_3_edit](assets/aem_6_3_edit.png). Exibe opções para adicionar campos e formatar a aparência de um campo.

   ![adobe-sign-block-select-fields](assets/adobe-sign-block-select-fields.png)

   **A.** Selecione e adicione campos do Adobe Sign. **B.** Expanda o bloco Adobe Sign para a visualização em tela cheia

1. Toque no ícone **Campo do Adobe Sign** ![aem_6_3_adobesign](assets/aem_6_3_adobesign.png). Ele exibe opções para selecionar e adicionar campos do Adobe Sign.

   Expanda o campo suspenso **Tipo** para selecionar um campo Adobe Sign e toque no ícone Concluído ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para adicionar o campo selecionado ao bloco Adobe Sign. O campo suspenso **Tipo** inclui os tipos de campos Assinatura, Informações do assinante e Dados. Integração do Adobe Sign com os campos de suporte do AEM Forms listados somente na caixa suspensa Tipo. Para obter informações detalhadas sobre campos do Adobe Sign, consulte [Documentação do Adobe Sign](https://helpx.adobe.com/sign/help/field-types.html).

   ![adobe-sign-block-fields-options](assets/adobe-sign-block-fields-options.png)

   É obrigatório fornecer um nome exclusivo para um campo. Você também pode selecionar a opção necessária para marcar um campo como obrigatório. Além das opções **Name** e **Required**, alguns campos do Adobe Sign têm mais opções. Por exemplo, máscara e várias linhas. Além disso, especifique um nome exclusivo para cada campo do Adobe Sign se os campos residem no mesmo bloco do Adobe Sign ou em blocos diferentes.

### Ative o Adobe Sign para um formulário adaptável {#enableadobsignforanadaptiveform}

A Adobe Sign não está ativada para um formulário adaptável. Execute as seguintes etapas para ativá-la:

1. No navegador de conteúdo, toque em **Container de formulário** e toque no ícone **Configurar** ![configurar](assets/configure.png). Ele abre o navegador de propriedades e exibe as propriedades do container de formulário adaptável.
1. No navegador de propriedades, expanda a opção **Assinatura eletrônica** e selecione a opção **Habilitar Adobe Sign**. Ele habilita o Adobe Sign para um formulário adaptável.
...
1. Selecione um serviço em nuvem na lista já configurada dos Cloud Services Adobe Sign.
   ...
   Se a lista **Adobe Sign Cloud Service** estiver vazia, siga o artigo [Configure o Adobe Sign com o AEM Forms](/help/forms/using/adobe-sign-integration-adaptive-forms.md) para configurar o serviço.
...
1. Selecione a ordem de assinatura na caixa de diálogo **Os assinantes podem assinar**. Os cantores Adobe Sign podem assinar um formulário adaptável **Sequencialmente** - um após outro assinante, ou **Simultaneamente** - em qualquer ordem.
...
1. [Adicione signatários a um ](#addsignerstoanadaptiveform) formato adaptável e toque no ícone Concluído para salvar as alterações.
...
1. No navegador de conteúdo, toque em **Container de formulário** e toque no ícone **Configurar** ![configurar](assets/configure.png). Ele abre o navegador de propriedades com as propriedades do container de formulário adaptável.
1. No navegador de propriedades, expanda a opção **Assinatura eletrônica** e selecione a opção **Habilitar Adobe Sign**. Ele habilita o Adobe Sign para um formulário adaptável.
...
1. ![detalhes telefônicos](assets/phone-details.png)
   ...
   * **Endereço de email do assinante:** especifique o endereço de email do assinante. O assinante recebe para ser assinado documentos/formulário no endereço de email especificado. Você pode optar por usar um endereço de email fornecido em um campo de formulário, AEM perfil do usuário conectado ou inserir manualmente um endereço de email. Trata-se de um passo obrigatório. Observe também que, se você configurou apenas um assinante, verifique se o endereço de email do assinante não é idêntico à conta da Adobe Sign usada para configurar os serviços em nuvem do AEM.
...
Além disso, um formulário adaptativo habilitado para Adobe Sign é enviado somente depois que todos os assinantes assinam o formulário. Você pode encontrar um formulário parcialmente assinado na seção Assinatura pendente do portal de formulários. O Adobe Sign Configuration Service continua a pesquisar o servidor Adobe Sign em [intervalos regulares](/help/forms/using/adobe-sign-integration-adaptive-forms.md) para verificar o status das assinaturas. Se todos os signatários concluírem a assinatura do formulário, o serviço de ação de envio será iniciado e o formulário será enviado. Se você estiver usando uma ação de envio personalizada e o formulário usar a Adobe Sign, atualize sua ação de envio personalizada para usar o serviço de ação de envio.

>[!NOTE]
>
>Os dados do formulário adaptável são armazenados temporariamente no Forms Portal. É recomendável usar [armazenamento personalizado para o Forms Portal](/help/forms/using/configuring-draft-submission-storage.md). Ela garante que os dados de PII (informações de identificação pessoal) não sejam armazenados em servidores AEM.
...
Depois de [editar as propriedades do formulário adaptável para o sinal de Adobe](#enableadobesign), execute as seguintes etapas para adicionar o campo de assinatura na nuvem a um formulário adaptável:
...
1. Toque no ícone **Campo do Adobe Sign** ![aem_6_3_adobesign](assets/aem_6_3_adobesign.png). Ele exibe opções para selecionar e adicionar campos do Adobe Sign.
   ...
   * [Selecione o Cloud Service Adobe Sign para um formulário adaptável](#selectadobesigncloudserviceforanadaptiveform)
...
1. Selecione o componente de etapa de assinatura recém-adicionado e toque no ícone **Configurar** ![configurar](assets/configure.png). Ele abre o navegador de propriedades e exibe as propriedades da etapa de assinatura. Configure as seguintes propriedades:
   ...
   * **Serviço de assinatura:** selecione a  **Adobe** Signotion.
   * **Usar componente** herdado de assinatura eletrônica: Se você estiver usando o respectivo formulário adaptável no  [AEM Forms Workspace](/help/forms/using/introduction-html-workspace.md), no aplicativo AEM Forms ou se o formulário adaptativo subjacente tiver um componente de assinatura eletrônica herdado, selecione a opção  **Usar** componente de assinatura E herdado.
   * **Configuração**: Selecione uma configuração (Adobe Sign Cloud Service). A caixa suspensa estará disponível somente se a opção **Usar componente E-sign** herdado estiver ativada.
   ...
   >* Os formulários adaptativos habilitados para Adobe Sign não suportam o uso do botão Enviar na seção ou no painel usando o componente Etapa de assinatura. Você pode adicionar uma etapa de resumo após a etapa Assinatura para o envio manual ou uma submissão automática é acionada após o intervalo definido usando o [Adobe Sign Configuration Service](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-scheduler-to-sync-the-signing-status).
...
**Ans:** Não, a AEM Forms não suporta o uso de um formulário adaptável que incorpora um formulário adaptável habilitado para assinatura pela Adobe Sign.
...
**Ans:O formulário** adaptativo criado usando o modelo avançado está configurado para usar o Adobe Sign. Para resolver o erro, crie e selecione uma configuração em nuvem do Adobe Sign e configure um assinante do Adobe Sign para o formulário adaptável.

**P: É possível usar tags de texto Adobe Sign em um componente de texto estático de um formulário adaptável?**

**Ans:** Sim, você pode usar tags de texto em um componente de texto para adicionar campos do Adobe Sign a um formulário adaptável habilitado para o  [Documento de Registro](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md)  (documento gerado automaticamente somente da opção de registro). Para saber mais sobre o procedimento e as regras para criar uma tag de texto, consulte [Documentação do Adobe Sign](https://helpx.adobe.com/sign/help/text-tags.html). Observe também que os formulários adaptativos têm suporte limitado para tags de texto. Você pode usar as tags de texto para criar apenas os campos compatíveis com o Adobe Sign Block.

**P: A AEM Forms fornece componentes de bloqueio e etapa de assinatura do Adobe Sign. Eles podem ser usados simultaneamente em um formulário adaptável?**

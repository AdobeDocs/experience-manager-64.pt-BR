...
Ative os fluxos de trabalho de assinatura eletrônica (Adobe Sign) para um formulário adaptável para automatizar os fluxos de trabalho de assinatura, simplificar os processos de assinatura única e múltipla e assinar eletronicamente formulários de dispositivos móveis.
...
1. [Editar propriedades de formulário adaptável para assinatura da Adobe](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)
1. [Adicionar campos do Adobe Sign a um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-868561487)
1. [Ativar o Adobe Sign para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
1. [Selecione o serviço Adobe Sign Cloud para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)

1. [Adicionar assinantes do Adobe Sign a um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
1. [Selecione Enviar ação para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. Na guia **[!UICONTROL Básico]** :
   ...
   1. Selecione o contêiner [de](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) configuração criado ao configurar o Adobe Sign com formulários AEM.

1. Na guia Modelo **[!UICONTROL de]** formulário, selecione uma das seguintes opções:

   * Selecione o modelo de formulário [!UICONTROL Associar como a opção Documento de modelo]de registro** e selecione um modelo Documento de registro. Se você usar um formulário adaptativo baseado em modelo de formulário, os documentos enviados para assinatura exibirão apenas os campos que se baseiam no modelo de formulário associado. Não exibe todos os campos do formulário adaptável.
...
1. Na guia **[!UICONTROL Básico]** , selecione o contêiner [de](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) configuração criado ao configurar o Adobe Sign com formulários AEM.
1. Na guia **[!UICONTROL Form Mode]**l, selecione uma das seguintes opções:
...
1. Selecione um serviço em nuvem na lista já configurada dos Adobe Sign Cloud Services.
   ...
   Se a lista **Adobe Sign Cloud Service** estiver vazia, siga o artigo [Configurar o Adobe Sign com formulários](/help/forms/using/adobe-sign-integration-adaptive-forms.md) AEM para configurar o serviço.
...
1. [Adicione signatários a um formulário](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) adaptável e toque no ícone Concluído para salvar as alterações.
...
Depois de [editar as propriedades do formulário adaptável para o Adobe sign](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052), execute as seguintes etapas para adicionar o campo de assinatura na nuvem a um formulário adaptável:
...
1. Toque no ícone **Adobe Sign Field** ![aem_6_3_adobesign](assets/aem_6_3_adobesign.png) . Ele exibe opções para selecionar e adicionar campos do Adobe Sign.
   ...
   * [Ativar o Adobe Sign para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
   * [Selecione o serviço Adobe Sign Cloud para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)
   * [Adicionar assinantes do Adobe Sign a um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
   * [Selecione Enviar ação para um formulário adaptável](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. [Adicione e configure o componente](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)Etapa de assinatura.
1. [Adicione o componente](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)Etapa de resumo.
...
**** Ans: Sim, você pode usar tags de texto em um componente de texto para adicionar campos do Adobe Sign a um formulário adaptável habilitado para [Documento de registro](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md) (Somente para documento gerado automaticamente da opção de registro). Para saber mais sobre o procedimento e as regras para criar uma tag de texto, consulte Documentação [do](https://helpx.adobe.com/sign/help/text-tags.html)Adobe Sign. Observe também que os formulários adaptativos têm suporte limitado para tags de texto. Você pode usar as tags de texto para criar apenas os campos compatíveis com o [Adobe Sign Block](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1373840282) .

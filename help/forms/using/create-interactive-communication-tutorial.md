...
Criar uma comunicação interativa usando todos os blocos de construção

![estilo da comunicação interativa](assets/styleaf.png)
...
1. Toque **Editar** para abrir a Comunicação interativa no painel direito.
1. Execute as etapas 6 - 15 de [Criar comunicação interativa para canal de impressão](#create-interactive-communication-for-print-channel) seção.
...
1. Como **Usar Imprimir como Principal para Canal da Web** for selecionada na etapa 4, o conteúdo e os vínculos serão gerados automaticamente para o canal da Web a partir do canal Imprimir.
   ...
   ![cancel_herança_web_channel](assets/cancel_inheritance_web_channel.png)
...
1. Repita as etapas 13 a 18 de [Criar comunicação interativa para canal da Web](#create-interactive-communication-for-web-channel) para inserir o **Pagar Agora** e **Assinar** hiperlinks no canal da Web da Comunicação interativa.

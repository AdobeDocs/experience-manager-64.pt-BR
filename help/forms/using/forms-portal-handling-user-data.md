...
* Para ações de envio diferentes da Ação **de envio do** Forms Portal, a opção **[!UICONTROL Armazenar dados no portal]** de formulários está ativada nas propriedades de **envio** do container de formulário adaptável.

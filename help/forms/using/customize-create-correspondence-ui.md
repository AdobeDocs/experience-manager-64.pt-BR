...
![O ícone personalizado na ](assets/0_1_introscreenshot.png)
...
* As dimensões padrão da imagem do logotipo são 48 px &amp;ast; 48 px. Certifique-se de que a imagem seja semelhante a este tamanho ou maior que 48 px &amp;ast; 48 px.

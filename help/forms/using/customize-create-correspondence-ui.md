...
* As dimensões padrão da imagem do logotipo são 48 px &amp;ast; 48 px. Certifique-se de que sua imagem seja semelhante a esse tamanho ou maior que 48 px &amp;ast; 48 px.

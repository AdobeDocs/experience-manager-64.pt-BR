...
1. Na instância do autor do AEM, vá para ![Ferramentas](assets/tools.png) > **[!UICONTROL Forms]** > **[!UICONTROL Gerenciar aplicativo]** de fluxo de trabalho e toque em **[!UICONTROL Criar]**.
...
1. Na instância do autor AEM, vá para ![Ferramentas](assets/tools.png) **[!UICONTROL Forms > Configurar pasta]** assistida. Uma lista de pastas monitoradas já configuradas é exibida.

...
[![ícone do crachá da Microsoft](assets/microsoft-badge-icon.png)](https://www.microsoft.com/en-us/store/p/adobe-experience-manager-forms/9nd12rlxtgtt)
...
### Aplicativo AEM Forms com servidores usando fluxo de trabalho centralizado na Forms no OSGi {#aem-forms-app-with-servers-using-forms-centric-workflow-on-osgi}
...
Para obter mais informações sobre o aplicativo AEM Forms que está trabalhando com o servidor AEM Forms, consulte a tarefa [de avaliação do](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) Conard gets na documentação do site de referência.

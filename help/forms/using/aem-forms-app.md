...
Para obter mais informações sobre o aplicativo AEM Forms que trabalha com o servidor AEM Forms, consulte a tarefa [de avaliação do](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) Conard gets na documentação de refsite.

...
Para obter mais informações sobre o aplicativo AEM Forms que está trabalhando com o servidor AEM Forms, consulte [o Painel obtém a tarefa de avaliação](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) na documentação de site de referência.
...
1. Para baixar o pacote, abra `https://<server>:<port>/crx/de/content/forms/mobileapps/src/adobe-lc-mobileworkspace-src-<version>.zip` no seu navegador.

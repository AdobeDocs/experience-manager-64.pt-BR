...
O aplicativo AEM Forms requer um servidor AEM Forms. Os usuários podem renderizar formulários criados nos AEM Forms\
...
Para obter mais informações sobre o aplicativo AEM Forms que trabalha com o servidor AEM Forms, consulte [o Painel obtém a tarefa](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) de avaliação na documentação de site.

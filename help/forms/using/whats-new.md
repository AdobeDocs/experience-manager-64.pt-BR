...
Para obter mais informações, consulte [Visão Geral de Comunicações Interativas](/help/forms/using/interactive-communications-overview.md).
...
Para obter mais informações, consulte [Imprimir canal e canal da Web](/help/forms/using/web-channel-print-channel.md).
...
### Interface aprimorada do agente {#enhanced-agent-interface}
...
Para obter mais informações, consulte [Uso de gráficos em Interative Communications](/help/forms/using/chart-component-interactive-communications.md).
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>Oracle Linux 7 Atualização 3</li> 
    </ul> </td> 
   <td> 
    <ul> 

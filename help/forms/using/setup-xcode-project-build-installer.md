...
1. Clique em Formulários **** AEM, em **DESTINOS**, selecione Formulários **** AEM. Selecione a guia **Criar configurações** , localize a seção Direito de assinatura de **código** e, nos campos Depurar e liberar, execute um dos seguintes procedimentos:

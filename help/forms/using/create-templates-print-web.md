...
1. Selecione **Linha 1** no painel esquerdo e selecione **Objeto** > **Ligação** > **Repetir Linha para Cada Item de Dados**.
   ...
   ![layout_fragment_print_again](assets/layout_fragment_print_repeat.png)
...
1. Selecione **Arquivo** > **Salvar como** para salvar o arquivo no sistema de arquivos local:
   ...
   Depois de criar um modelo XDP para fragmentos de layout usando o Forms Designer, você deve [carregá-lo](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server) no servidor AEM Forms para que o modelo esteja disponível para uso ao criar fragmentos de layout.
...
* [Ativação de botões no Interative Communications](/help/forms/using/create-templates-print-web.md#enabling-buttons-in-interactive-communications)

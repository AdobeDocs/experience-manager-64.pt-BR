...
1. Selecione **Arquivo** > **Salvar como** para salvar o arquivo no sistema de arquivos local:
   ...
   Depois de criar um modelo XDP para o fragmento de layout usando o Forms Designer, você deve [carregá-lo](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server) no servidor do AEM Forms para que o modelo fique disponível para uso ao criar fragmentos de layout.

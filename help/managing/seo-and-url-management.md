...
* Quanto mais legível por humanos for um URL, melhor; ter palavras-chave presentes no URL aumentará o valor.
   ...
   * Por exemplo: `mybrand.com/products/product-detail.product-category.product-name.html` é preferível a `mybrand.com/products/product-detail.1234.html`

...
1. Toque ou clique no botão **Estilos** na barra de ferramentas do componente **Lista** para abrir o menu de estilos e alterar a aparência do componente.
   ...
   >[!NOTE]
   >
   >Neste exemplo, os estilos de **Layout** (**Bloco** e **Grade**) são mutuamente exclusivos, enquanto que as opções de **Exibição** (**Imagem** ou **Data**) podem ser combinadas. Isso pode ser [configurado no modelo como o autor do modelo](/help/sites-authoring/style-system.md#as-a-template-author).

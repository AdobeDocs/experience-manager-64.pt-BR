...
1. Adicione o componente **[!UICONTROL Fragmento do conteúdo]**; do navegador **[!UICONTROL Componentes]** ou **[!UICONTROL Inserir novo componente]**. 

1. Você pode:

   * Abra o navegador **[!UICONTROL Ativos]** e filtre por **[!UICONTROL Fragmentos de conteúdo]** (o padrão é Imagens). Em seguida, arraste o fragmento necessário na instância do componente.
   * Selecione o componente do fragmento de conteúdo e clique em **[!UICONTROL Configurar]** na barra de ferramentas. Na caixa de diálogo, é possível abrir a caixa de diálogo de seleção para procurar e selecionar o **[!UICONTROL Fragmento do conteúdo]** necessário.
   >[!NOTE]
   >
...
* **[!UICONTROL Fragmento do conteúdo]**
...
É possível abrir a origem do fragmento para edição (o ativo) usando o ícone **[!UICONTROL Editar]** na barra de ferramentas do componente. Isso permitirá que você [edite e gerencie o fragmento do conteúdo](/help/assets/content-fragments.md). 
...
Quando um fragmento do conteúdo específico for adicionado à página, há um espaço reservado para **[!UICONTROL Arrastar os componentes aqui]** entre cada parágrafo HTML (e na parte superior/inferior) do fragmento.

...
* **Modelos permitidos**
   ...
   [Defina a lista de modelos que estará disponível](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) dentro desta sub-ramificação.

* **Requisitos de autenticação**

   Habilita (ou desabilita) o uso de autenticação para acessar a página.

   O requisito para usar autenticação pode ser definido aqui junto com uma página designada para logon. Os grupos de usuários fechados para a página são definidos na guia **[Permissões](/help/sites-authoring/editing-page-properties.md#permissions)**.

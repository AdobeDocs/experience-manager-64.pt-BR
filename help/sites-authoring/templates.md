...
* Modelos editáveis
   ...
   * Podem ser [criados](#creating-a-new-template-template-author) e [editados](#editing-templates-template-authors) pelos autores de modelo usando o console e o editor de **Modelo**. O console **Modelo** é acessível na seção **Geral** do console **Ferramentas**.
...
* **Política e propriedades (geral)**
   ...
   *Recursos*
   ...
   >[!NOTE]
   >
   >[](/help/sites-administering/rich-text-editor.md)As políticas de conteúdo para componentes que implementam o editor de rich text só podem ser definidas para opções disponibilizadas pelo RTE pelas configurações da interface do usuário.

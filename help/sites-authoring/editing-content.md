...
1. [Editar](#edit-configure-copy-cut-delete-paste) o componente.
...
Se, ao navegar pelos ativos, você perceber que precisa fazer uma alteração rápida a um ativo, é possível iniciar o [editor de ativos](/help/assets/managing-assets-touch-ui.md) diretamente do navegador, clicando no ícone de edição ao lado do nome do ativo.
...
* [Arrastar e soltar um ativo](#inserting-a-component-using-the-assets-browser) no navegador de ativos para adicionar conteúdo diretamente.

...
# Guia do usuário para desenvolvimento do AEM 6.4 {#developing}
...
+ Práticas recomendadas    {#bestpractices}
   ...
   + [Diretrizes de desenvolvimento de AEM e práticas recomendadas](dev-guidelines-bestpractices.md)

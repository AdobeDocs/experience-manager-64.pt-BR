...
+ Introdução para desenvolvedores{#introduction}
   ...
   + [Estrutura da interface do usuário habilitada para toque do AEM](touch-ui-structure.md)
   + [Conceitos da interface do usuário habilitada para toque do AEM](touch-ui-concepts.md)
   + [Desenvolvimento do AEM - Diretrizes e práticas recomendadas](dev-guidelines-bestpractices.md)
   + [Usar bibliotecas do lado do cliente](clientlibs.md)
   ...
   + [Contribuição para o AEM](contributing-to-cq.md)
...
+ Gerenciamento de experiência headless{#headless}
   ...
   + Aplicativos de página única{#spas}
      + [Introdução ao SPA e explicação passo a passo](spa-walkthrough.md)
      + [Tutorial WKND do SPA](spa-wknd.md)
      + [Introdução aos SPAs no AEM - React](spa-getting-started-react.md)
      + [Introdução aos SPAs no AEM - Angular](spa-getting-started-angular.md)
      + [Implementar um componente de reação para SPA](spa-implementing-react-component.md)
      ...
      + [Roteamento do Modelo SPA](spa-routing.md)
      + [Integração de SPA e Adobe Experience Platform Launch](spa-launch.md)
      + [Renderização de SPAs e do servidor](spa-ssr.md)
...
+ Extensão do AEM{#extending-aem}
   ...
   + Extensão de fluxos de trabalho{#extending-workflows}
      ...
      + [Ampliação da funcionalidade de Fluxo de trabalho](workflows-customizing-extending.md)
      + [Interação com fluxos de trabalho programaticamente](workflows-program-interaction.md)
      + [Referência em etapas do fluxo de trabalho](workflows-step-ref.md)
      + [Práticas recomendadas do workflow](workflows-best-practices.md)
      + [Referência no processo do fluxo de trabalho](workflows-process-ref.md)
   ...
   + Rastreamento e análise{#extending-analytics}
      ...
      + [Adicionar o rastreamento do Adobe Analytics aos componentes](extending-analytics-components.md)
   ...
   + Cloud Services{#extending-cloud-services}
      ...
      + [Criação de um serviço personalizado na nuvem](extending-cloud-config-custom-cloud.md)
   ...
   + Forms{#extending-forms}
      ...
      + [Criação de modelo de página do AEM personalizado com componentes de formulário do Adobe Campaign](extending-campaign-custom-template.md)
...
+ Práticas recomendadas    {#bestpractices}
   ...
   + [Diretrizes de desenvolvimento do AEM e práticas recomendadas](https://experienceleague.adobe.com/docs/experience-manager-64/developing/introduction/dev-guidelines-bestpractices.html)

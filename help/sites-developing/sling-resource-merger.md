...
* **[Sobreposições](/help/sites-developing/overlays.md)**de recursos usando os caminhos[de pesquisa](/help/sites-developing/overlays.md#configuring-the-search-paths)configurados.

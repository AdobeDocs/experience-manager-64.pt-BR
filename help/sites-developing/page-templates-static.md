...
>[!NOTE]
>
>[Modelos](/help/sites-developing/page-templates-editable.md) editáveis também estão disponíveis e são o tipo recomendado de modelos para maior flexibilidade e os recursos mais recentes.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> allowPaths</td> 
   <td> Sequência de caracteres[]</td> 
   <td>Caminho de uma página que tem permissão para se basear neste modelo.<br /> </td> 
  </tr> 
  <tr> 
   <td> jcr:created</td> 
   <td> Data</td> 
...
Na maioria dos casos, você pegará um modelo existente e desenvolverá um novo para seu próprio uso. Consulte [Desenvolvimento de modelos](#developing-page-templates) de página para obter mais informações.

Para habilitar um modelo existente para seu site e desejar que ele seja exibido na caixa de diálogo **Criar página** ao criar uma página diretamente em **Sites** a partir do console **Sites** , defina a propriedade allowPaths do nó modelo como: **/content(/.&amp;ast;)?**

## Como os modelos são aplicados {#how-template-designs-are-applied}

Quando os estilos são definidos na interface usando o Modo [de](/help/sites-authoring/default-components-designmode.md)Design, o design é mantido no caminho exato do nó de conteúdo para o qual o estilo está sendo definido.
...
Se os designs só forem aplicados usando o Modo de design, as seguintes seções, Resolução [do caminho de](/help/sites-developing/page-templates-static.md#design-path-resolution)design, Árvore [decisória](/help/sites-developing/page-templates-static.md#decision-tree)e [Exemplo](/help/sites-developing/page-templates-static.md#example) não serão aplicáveis.
...
Esta é uma representação gráfica da lógica de Resolução [do Caminho de](/help/sites-developing/page-templates-static.md#design-path-resolution) Design.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>root</code></td> 
   <td>Se tudo mais falhar, veja o que resta.<br /> </td> 
  </tr> 
  <tr> 
   <td><code>branch</code></td> 
   <td><code>branch</code></td> 
  ...
  <tr> 
   ...
   <td><code>root</code></td> 
   <td><p>Se não houver uma correspondência exata, pegue a que estiver na árvore.</p> <p>Pressupõe-se que isso será sempre aplicável, mas mais acima da árvore pode ser muito específico.<br /> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Atualize o **sling:resourceType** do nó **jcr:content** do modelo para referenciar o novo componente.

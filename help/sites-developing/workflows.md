...
>* As alterações nos locais das informações podem ser consultadas [Reestruturação do repositório no AEM 6.4](/help/sites-deploying/repository-restructuring.md) e [Práticas recomendadas do fluxo de trabalho - Localizações](/help/sites-developing/workflows-best-practices.md#locations).
>

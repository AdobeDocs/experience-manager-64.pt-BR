...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>String</code></td> 
   <td>Caminho para uma caixa de diálogo para cobrir o caso quando o componente não tem um nó de diálogo.<br /> </td> 
  </tr> 
  <tr> 
   <td> </td> 
   <td> </td> 

...
* Específico do site
   ...
   As pastas específicas do site que você cria para organizar seus modelos são criadas com uma conta que possui privilégios de administrador.
...
1. **Ativar o modelo**
   ...
   * [Habilitando o ](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) modelo do console  **** Modelos.

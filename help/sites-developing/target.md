...
>[!NOTE]
>
>Somente a versão do `at.js` enviado com o produto é suportada. A versão do `at.js` enviado com o produto pode ser obtida consultando o `at.js` arquivo no local `/etc/clientlibs/foundation/testandtarget/atjs/source/at.js`.

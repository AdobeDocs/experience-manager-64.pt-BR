...
>[!NOTE]
>
>O recurso Editor de aplicativo de página única (SPA) exige o Service Pack 2 [do](/help/release-notes/sp-release-notes.md) AEM 6.4 ou mais recente.
>
...
* [Introdução aos SPAs no AEM](/help/sites-developing/spa-getting-started-react.md) para um rápido tour de um SPA simples
...
1. O Editor SPA persiste nas edições com uma solicitação POST para o servidor.
...
O AEM SPA Editor SDK foi introduzido com o AEM 6.4 service pack 2. Ele é totalmente compatível com a Adobe e, como um novo recurso, continua sendo aprimorado e expandido. Os seguintes recursos do AEM ainda não são abordados pelo Editor SPA:

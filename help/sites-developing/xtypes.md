...
Para obter informações completas sobre todos os widgets disponíveis no AEM consulte [documentação da API do widget](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html).
...
* caixa
   ...
   Classe base para qualquer [Componente](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) que deve ser dimensionado como uma caixa, usando largura e altura.
...
* janela de navegação
   ...
   A caixa de diálogo Procurar permite que o usuário navegue pelo repositório para selecionar um caminho. Normalmente é usado por meio de um [BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField).
...
* browsefield
   ...
   **Obsoleto: Use [CQ.form.PathField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) instead**
...
* bulkeditor
   ...
   O BulkEditor deve ser inserido em um formulário HTML (exigido pela funcionalidade de importação). Isso funciona perfeitamente com uma [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog).
...
* checkboxgroup
   ...
   Um contêiner de agrupamento para [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) controles.
...
* colormenu
   ...
   Um menu contendo um [CQ.Ext.ColorPalette](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) Componente.
...
* contentfinder
   ...
   O ContentFinder é uma coluna especializada de duas colunas [Viewport](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) que contém o Localizador de conteúdo real à esquerda e o Quadro de conteúdo à direita.
...
* cq.workflow.model.combo
   ...
   O WorkflowModelCombo é personalizado [CQ.Ext.form.ComboBox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox) que mostra uma lista de modelos de fluxo de trabalho disponíveis.
...
* customcontentpanel
   ...
   CustomContentPanel é um tipo especial de painel para ser usado em [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog): Seu conteúdo é recuperado de e enviado a um URL diferente dos outros campos na caixa de diálogo.
...
* datefield
   ...
   Fornece um campo de entrada de data com um [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) lista suspensa e validação automática de data.
...
* datemenu
   ...
   Um menu contendo um [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) Componente.
...
* datepicker
   ...
   Um seletor de data pop-up. Essa classe é usada pelo [DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) classe para permitir a navegação e seleção de datas válidas.
...
* editor
   ...
   Embora não esteja listado aqui, a EditBar tem todos os membros do [CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase).
...
* edição
   ...
   [CQ.wcm.EditRolover](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditRollover)
...
* htmleditor
   ...
   Os botões da barra de ferramentas do editor têm dicas de ferramentas definidas no [buttonTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor) propriedade.
...
* listview
   ...
   CQ.Ext.list.ListView é uma implementação rápida e leve de um [Grade](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) como visualização.
...
* lvcolumn
   ...
   Essa classe encapsula os dados de configuração da coluna a serem usados na inicialização de um [ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView).
...
* mediabrowsedialog
   ...
   **Obsoleto: Use [Localizador de conteúdo](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder) para navegar pela mídia.**
...
* senha
   ...
   A senha é como um [CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) mas mantém seu valor privado, permitindo que os usuários insiram dados confidenciais.
...
* radiogurte
   ...
   Um contêiner de agrupamento para [CQ.Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio) controles.
...
* plano de implementação
   ...
   O RolloutPlan fornece uma caixa de diálogo para observar o progresso de uma implantação de página. O RolloutPlan é iniciado por um [CQ.wcm.msm.RolloutWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard).
...
* slideshow
   ...
   O componente de Apresentação é baseado no [CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage) componente.
...
* tableedit
   ...
   **Obsoleto: Use [CQ.form.TableEdit2](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2) em vez disso.**

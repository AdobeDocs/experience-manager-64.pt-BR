...
>[!NOTE]
>
>Os recursos estáticos abaixo da pasta da biblioteca do cliente devem estar em uma pasta chamada *resources*. Se você não tiver os recursos estáticos, como imagens, na pasta *resources*, ele não poderá ser referenciado em uma instância de publicação. Veja um exemplo: http://localhost:4503/etc.clientlibs/geometrixx/components/clientlibs/resources/example.gif
...
Para obter informações sobre como configurar o serviço, consulte [AEM Gerenciador de biblioteca HTML](/help/sites-deploying/osgi-configuration-settings.md).

...
1. Criar uma nova pasta de sling ( `sling:Folder`)
...
Para obter mais informações sobre os elementos de API que podem ser usados ao gravar scripts, consulte os [javadocs relacionados aos formulários](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/forms/package-summary.html).

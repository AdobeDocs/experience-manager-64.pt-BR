...
Há diversas variáveis predefinidas no Adobe Analytics que podem ser configuradas em uma estrutura**. **As variáveis **charset**, **cookieLifetime**, **currencyCode** e **trackInlineStats** são incluídas na lista **Configurações Gerais do Analytics** por padrão.

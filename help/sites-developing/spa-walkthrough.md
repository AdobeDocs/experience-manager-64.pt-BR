...
1. Carregue o aplicativo We.Retail Journal no servidor de publicação ou usando a opção **[!UICONTROL Exibir como publicado]** do menu Informações **da** página no editor de página.
...
1. Se ainda não tiver sido carregado, carregue o aplicativo We.Retail Journal no servidor de publicação ou usando a opção **[!UICONTROL Exibir como publicado]** do menu Informações **da** página no editor de página.

...
* When [criação de páginas](/help/sites-authoring/default-components.md), os componentes permitem que os autores editem e configurem o conteúdo.
   ...
   * Ao construir um [Comércio](/help/sites-administering/ecommerce.md) site em que os componentes podem, por exemplo, coletar e renderizar informações do catálogo.

      Consulte [Desenvolvimento do comércio eletrônico](/help/sites-developing/ecommerce.md) para obter mais informações.
...
O [Modo WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) cookie é definido ao alternar para **Visualizar** mesmo quando a página não é atualizada.
...
>[!NOTE]
>
>Na interface habilitada para toque, somente os valores `EDIT` e `PREVIEW` são usados para [Modo WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) cookie.
...
>Consulte:
>
>* a sessão AEM Gems em [Personalização de campos de diálogo](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2015/aem-customizing-dialog-fields-in-touch-ui.html).
...
>[!NOTE]
>
>Para obter detalhes completos sobre a interface do usuário do Granite, consulte o [Documentação da interface do usuário do Granite](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/granite-ui/api/index.html).
...
O método de tratamento de eventos em campos de diálogo agora é feito com [ouvintes em uma biblioteca cliente personalizada](#listeners-in-a-custom-client-library). Isso é uma mudança no método antigo de ter [ouvintes na estrutura do conteúdo](#listeners-in-the-content-structure).
...
* definição dos componentes [propriedade no sistema de parágrafo de um modelo](/help/sites-developing/components-basics.md#adding-your-component-to-the-paragraph-system).
...
* Fornece alguns [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html) suporte, a linguagem de modelo criada para simplificar o desenvolvimento de componentes e aumentar a segurança.
...
* HTL
   ...
   * Utilização de [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html) não é obrigatório, mas se seu componente precisar de atualização, é o momento ideal para considerar [migração de JSP para HTL](/help/sites-developing/components-basics.md#htl-vs-jsp).
...
* Caixas de diálogo
   ...
   * O [Ferramentas de Modernização AEM](/help/sites-developing/modernization-tools.md) O é fornecido para ajudá-lo a estender os componentes existentes.
   ...
   * Personalização de campos, para obter mais informações, consulte a sessão AEM Gems em [Personalização de campos de diálogo](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2015/aem-customizing-dialog-fields-in-touch-ui.html).
   * Migrar de vtypes para [Validação da interface do usuário do Granite](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/components/foundation/clientlibs/foundation/js/validation/index.html)
   * Uso de ouvintes JS, para obter mais informações, consulte [Tratamento de eventos de campo](#handling-field-events) e a sessão AEM Gems em [Personalização de campos de diálogo](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2015/aem-customizing-dialog-fields-in-touch-ui.html).
...
O Markdown suportado é igual ao do [fragmentos de conteúdo](/help/assets/content-fragments-markdown.md).

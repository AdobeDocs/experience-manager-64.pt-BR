...
Esta página fornece a documentação de referência (ou links para a documentação de referência) necessária para desenvolver novos componentes para AEM. Consulte [Desenvolvimento de componentes AEM - Exemplos](/help/sites-developing/developing-components-samples.md) de código para obter alguns exemplos práticos.
...
>Consulte:
>
>* a sessão Gems AEM em [Personalizar campos](https://docs.adobe.com/content/ddc/en/gems/customizing-dialog-fields-in-touch-ui.html)de diálogo.
...
A AEM predefinida verifica apenas o componente de referência. Para adicionar seu componente, é necessário configurar a Configuração **de referência de conteúdo de criação do pacote OSGi** WCM.
...
AEM oferta a possibilidade de configurar um sistema de parágrafo em sua página para que [uma instância do novo componente seja criada automaticamente quando um usuário arrasta um ativo (apropriado) para uma instância dessa página](/help/sites-authoring/editing-content.md) (em vez de sempre ter que arrastar um componente vazio para a página).
...
## Uso da extensão de suportes de AEM {#using-the-aem-brackets-extension}

A extensão [de](/help/sites-developing/aem-brackets.md) AEM de suportes fornece um fluxo de trabalho suave para editar AEM componentes e bibliotecas de clientes. Ele é baseado no editor de código [do Brackets](https://brackets.io/) .
...
* Caixas de diálogo
   ...
   * Para obter mais informações, consulte a sessão Gems AEM em [Personalizar campos](https://docs.adobe.com/content/ddc/en/gems/customizing-dialog-fields-in-touch-ui.html)de diálogo.
   ...
   * Usando ouvintes JS, para obter mais informações, consulte [Manuseio de Eventos](#handling-field-events) de campo e a sessão Gems AEM em [Personalização de campos](https://docs.adobe.com/content/ddc/en/gems/customizing-dialog-fields-in-touch-ui.html)de diálogo.

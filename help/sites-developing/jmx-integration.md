...
Use o BundleContext para registrar o MBean como um serviço OSGi. Inclua as informações relacionadas ao JMX no objeto do dicionário que você usa como argumento da variável `BundleContext.registerService` método .
...
>[!NOTE]
>
>Para simplificar, o código neste exemplo não executa o registro ou reage às exceções lançadas.

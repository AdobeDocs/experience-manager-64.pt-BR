...
Use o BundleContext para registrar o MBean como um serviço OSGi. Inclua as informações relacionadas ao JMX no objeto Dictionary que você usa como argumento do `BundleContext.registerService` método.

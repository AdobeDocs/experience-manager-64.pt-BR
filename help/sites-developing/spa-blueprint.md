...
As duas entidades se relacionam à noção de roteamento, mas [`ModelRouter`](/help/sites-developing/spa-routing.md) é responsável apenas por ter [`PageModelManager](/help/sites-developing/spa-blueprint.md#pagemodelmanager) carregado com um modelo de dados estruturado em sincronia com o estado atual do aplicativo.

...
Na implementação acima, o componente do projeto é estendido com a funcionalidade vazia antes de ser realmente registrado na loja Mapeamento [de](/help/sites-developing/spa-blueprint.md#componentmapping) componentes. Isso é feito encapsulando e estendendo a biblioteca [ComponentMapping](#componentmapping) para introduzir o suporte do objeto de `EditConfig` configuração:

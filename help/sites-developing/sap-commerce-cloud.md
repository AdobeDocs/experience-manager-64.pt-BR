...
O ponto de entrada da API de pesquisa é o `CommerceService#search` método que retorna um `CommerceResult` objeto. Consulte a [Documentação da API](/help/sites-developing/ecommerce.md#api-documentation) para obter mais informações sobre este tópico.

...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Para obter mais informações sobre solicitações que podem ser armazenadas em cache e recomendações gerais de otimização de desempenho do Dispatcher, consulte Otimização <a href="/help/sites-deploying/configuring-performance.md#optimizing-performance-when-using-the-dispatcher">de Desempenho do</a>Dispatcher.</td> 
  </tr> 
  <tr> 
   <td><strong>Etapa 4</strong></td> 
   <td>As solicitações vêm do Dispatcher?</td> 
   <td><p>Verifique a documentação <a href="https://helpx.adobe.com/experience-manager/dispatcher/using/dispatcher-configuration.html#debugging">de depuração do</a> Dispatcher para ver se as solicitações estão armazenadas em cache corretamente.<br /> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Consulte a documentação sobre as Diretrizes <a href="/help/managing/hardware-sizing-guidelines.md">de dimensionamento de</a>hardware.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>Você pode verificar se há solicitações lentas analisando o <code>request.log</code> ou usando <code>rlog.jar</code>.</p> <p>Para obter mais informações sobre como usar o rlog.jar, consulte esta página.</p> <p>Consulte <a href="/help/sites-deploying/monitoring-and-maintaining.md#using-rlog-jar-to-find-requests-with-long-duration-times">Usar rlog.jar para localizar solicitações com tempos</a>de longa duração.<br /> </p> <p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>E/S de disco</td> 
   <td><p>Consulte a seção E/S <a href="/help/sites-deploying/monitoring-and-maintaining.md#disk-i-o">do</a> disco na documentação Monitoramento e manutenção.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    <ol> 
     ...
     <li>Dicas de ajuste de desempenho são artigos <a href="https://helpx.adobe.com/experience-manager/kb/performance-tuning-tips.html">aqui</a> e <a href="https://helpx.adobe.com/experience-manager/kb/performance-tuning-tips.html">aqui</a>.<br /> </li> 
    </ol> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Usando HTTP/2</td> 
   <td>Consulte a Sessão Gem para ver as etapas 37, 38 e 39. Além disso, consulte <a href="https://help-forums.adobe.com/content/adobeforums/en/experience-manager-forum/adobe-experience-manager.topic.html/forum__kdzc-does_anyoneknowwhe.html">esta</a> publicação do fórum no suporte a HTTP/2.<br /> </td> 
  </tr> 
  <tr> 
   <td><strong>Etapa 49</strong></td> 
   <td>Reduzir tamanho da carga</td> 
   <td><a href="/help/sites-deploying/osgi-configuration-settings.md">Ative o Gzip</a> e <a href="https://docs.adobe.com/ddc/en/gems/aem-web-performance.html">reduza o tamanho</a>da imagem.<br /> </td> 
  </tr> 
  <tr> 

...
1. Após a conclusão do processo de manutenção e reinício das instâncias:
   ...
   * No standby, a coleta de lixo do armazenamento de dados está disponível somente por meio do **BlobGarbageCollection** MBean - `startBlobGC()`. O MBean **RepositoryManagement** não está disponível no standby.

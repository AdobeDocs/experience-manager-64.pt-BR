...
Para sites que planejam implantar [AEM Communities](/help/communities/overview.md), é recomendável [escolher uma implantação](/help/communities/working-with-srp.md) otimizada para lidar com o UGC postado pelos membros da comunidade do ambiente de publicação.

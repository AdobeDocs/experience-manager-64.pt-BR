...
Com o lançamento dos Serviços AEM e AEM Segurança Doc, agora temos a capacidade de chamar os serviços de documento do LiveCycle para renderizar um formulário XFA, converter um documento em PDF e proteger um documento por política. Leia [AEM Conector](https://helpx.adobe.com/livecycle/help/aem/aem-livecycle-connector.html) do LiveCycle para obter mais detalhes.

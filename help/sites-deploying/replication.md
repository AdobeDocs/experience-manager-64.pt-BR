...
>[!NOTE]
>
>Isso pode ser combinado com o uso da ID [de usuário do](#settings) agente para selecionar conteúdo diferente para replicação para os ambientes de publicação individuais. Para cada ambiente de publicação:
>

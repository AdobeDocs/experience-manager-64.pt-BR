...
Para executar a atualização, é importante começar a AEM usando o arquivo jar para trazer a instância para frente. Para atualizar para a versão 6.4, consulte também outras opções de reestruturação e migração de conteúdo em [Migração de conteúdo ocioso](/help/sites-deploying/lazy-content-migration.md) que você pode escolher com o comando de atualização.

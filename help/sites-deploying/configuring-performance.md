...
* CPU - núcleos múltiplos permitem um trabalho mais suave ao transcodificar
...
Os tópicos reais da tarefa que os modelos de fluxo de trabalho geram incluem o sufixo específico do modelo. Por exemplo, o modelo de fluxo de trabalho Atualizar ativo DAM gera trabalhos com o seguinte tópico:
...
A ferramenta [Dispatcher](https://helpx.adobe.com/experience-manager/dispatcher/using/dispatcher.html) é Dispatcher e/ou Adobe de balanceamento de carga. Ao usar o Dispatcher, você deve considerar a otimização do seu site para o desempenho do cache.

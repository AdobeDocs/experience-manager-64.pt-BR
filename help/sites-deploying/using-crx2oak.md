...
Você pode baixar a versão mais recente do crx2oak do repositório público da Adobe neste local:\
...
A lista de alterações e correções da versão mais recente pode ser encontrada nas Notas [de versão do](/help/release-notes/crx2oak.md)CRX2Oak.

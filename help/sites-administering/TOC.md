...
+ Integração {#integration}
   ...
   + [Integração com a Adobe Creative Cloud](https://docs.adobe.com/content/help/en/experience-manager-64/assets/administer/aem-cc-integration-best-practices.html)
...
+ Práticas recomendadas      {#bestpractices}
   ...
   + [Lidar com solicitações de GDPR para a AEM Foundation](https://experienceleague.adobe.com/docs/experience-manager-64/administering/security/handling-gdpr-requests-for-aem-platform.html)
   + [AEM Commerce - Preparação para o GDPR](https://experienceleague.adobe.com/docs/experience-manager-64/administering/ecommerce/gdpr-compliance-commerce.html)

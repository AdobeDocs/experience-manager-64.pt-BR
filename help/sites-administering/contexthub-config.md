...
Para salvar dados do serviço MD5 do site jsontest.com, use o procedimento em [Criação de um armazenamento do ContextHub](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store) usando as seguintes propriedades:
...
Use o procedimento em [Adição de um módulo de interface do usuário](/help/sites-administering/contexthub-config.md#adding-a-ui-module) para adicionar o módulo de interface de usuário a um modo de interface de usuário existente, como o modo de interface Perona de amostra. Para o Módulo de interface do usuário do , use os seguintes valores de propriedade:

...
seo-description: A partir de 31 de janeiro de 2014, a plataforma do visualizador DHTML do Scene7 será oficialmente encerrada. Esta notificação fornece respostas para perguntas frequentes para que você possa se preparar para essa transição para a nova plataforma do visualizador HTML5.

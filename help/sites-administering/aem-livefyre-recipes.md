...
O Pacote Livefyre Adobe Experience Manager está disponível para AEM 6.1, 6.2SP1, 6.3, 6.4 e 6.4 SP1. AEM 5.x e 6.0 não são compatíveis. Para obter instruções detalhadas, consulte [Integração com o Livefyre](/help/sites-administering/livefyre.md).

Para saber quais aplicativos do Livefyre são compatíveis, consulte [Matriz de suporte AEM para aplicativos do Livefyre](/help/sites-administering/livefyre.md#aem-support-matrix-for-livefyre-apps).
...
1. [Introdução](/help/sites-administering/livefyre.md#getting-started)
1. [Configurar AEM para usar o Livefyre](/help/sites-administering/livefyre.md#configure-aem-to-use-livefyre-create-a-configuration-folder)
1. [Importar UGC curado pelo Livefyre no AEM Assets](/help/sites-administering/livefyre.md#use-livefyre-with-aem-assets)

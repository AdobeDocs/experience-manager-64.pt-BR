...
description: 'Instruções detalhadas sobre casos de uso comuns do Adobe Experience Manager Livefyre. '
seo-description: 'Instruções detalhadas sobre casos de uso comuns do Adobe Experience Manager Livefyre. '
...
Instruções detalhadas sobre casos de uso comuns do Adobe Experience Manager Livefyre.
...
* **** Como:  [Criar, visualizar, publicar e incorporar um aplicativo Media Wall](https://marketing.adobe.com/resources/help/en_US/livefyre/c_create_an_app.html)

* **** Exemplo: [https://codepen.io/dharafyre/pen/bvGrLo](https://codepen.io/dharafyre/pen/bvGrLo)

**Método 2: Implementação do SDK**

* **** O que: O [Livefyre.js](https://marketing.adobe.com/resources/help/en_US/livefyre/c_livefyre.js.html) é a biblioteca principal que alimenta o Apps e o Auth em um site. Ele define o objeto global *window.Livefyre* e um único método público, *Livefyre.requirements*, que pode ser usado para carregar outras bibliotecas do Livefyre JavaScript que ajudam a incorporar aplicativos Livefyre e a integrar-se a plataformas de autenticação de usuário de terceiros.

* **Como**: [Use o pacote simplificado do Livefyre JavaScript SDK](https://marketing.adobe.com/resources/help/en_US/livefyre/?f=c_media_wall_app&s=c_media_wall_integration)
...
* Para criar experiências personalizadas e visualizações de dados, os aplicativos Livefyre podem ser criados do zero, usando o Livefyre e os dados sociais usando a API [](https://marketing.adobe.com/resources/help/en_US/livefyre/bootstrap-stream-api.html)Bootstrap e Stream.
...
* [Integração](https://marketing.adobe.com/resources/help/en_US/livefyre/t_about_identity_integration.html) de identidade para plataformas de autenticação de terceiros
...
1. [Configure os fluxos e adicione regras para preparar o UGC e exibir no componente Media Wall](https://marketing.adobe.com/resources/help/en_US/livefyre/c_streams.html)
...
Para aplicativos Livefyre que exigem autenticação, consulte Integração [de](https://marketing.adobe.com/resources/help/en_US/livefyre/t_about_identity_integration.html) identidade para plataformas de autenticação de terceiros.

* [Mídia de tour PGA](https://www.pgatour.com/social-hub.html)
* [Tempo limite](https://www.timeout.com/london/restaurants/forest-bar-kitchen#tab_panel_3)

## Integrar comentários do Livefyre usando componentes do AEM ou integração tradicional do Livefyre {#integrate-livefyre-comments-using-aem-components-or-traditional-livefyre-integration}
...
* **** O que: A maneira mais fácil e rápida de integrar um aplicativo Livefyre. Você pode projetar, configurar e gerar um código incorporado JavaScript personalizado para integrar um aplicativo Media Wall em uma página em minutos.
* **** Como: [Criar, visualizar, publicar e incorporar um aplicativo de comentários](https://marketing.adobe.com/resources/help/en_US/livefyre/c_create_an_app.html)
...
* **Como:**
   ...
   * Crie uma coleção/aplicativo usando o token [](https://marketing.adobe.com/resources/help/en_US/livefyre/t_create_a_collectionmeta_token.html)CollectionMeta.
   * Integre o aplicativo [](https://marketing.adobe.com/resources/help/en_US/livefyre/c_comments_integration.html) Comments a sites usando a estrutura de código incorporada do Livefyre.js.
...
## Usar a integração do Livefyre AEM Assets para importar o UGC nos ativos AEM {#use-livefyre-aem-assets-integration-to-import-ugc-in-aem-assets}

**Configuração do Livefyre (para Curadoria UGC e Gerenciamento de Direitos):**

1. [Configure os fluxos e adicione regras para preparar o UGC às pastas](https://marketing.adobe.com/resources/help/en_US/livefyre/c_streams.html)da biblioteca de ativos do Livefyre.
...
1. [Colete, organize e gerencie o UGC com curadoria nas pastas](https://marketing.adobe.com/resources/help/en_US/livefyre/c_assets.html)da Biblioteca de ativos do Livefyre.
...
1. [Solicite direitos para UGC com curadoria usando o Livefyre Studio](https://marketing.adobe.com/resources/help/en_US/livefyre/c_how_requesting_rights_works.html).

**Configuração do AEM (para importar UGC para ativos AEM):**
...
1. [Importar UGC organizado pelo Livefyre nos ativos AEM](https://https://helpx.adobe.com/experience-manager/6-3/sites/administering/using/livefyre.html#UseLivefyrewithAEMAssets)
...
* **Como:**
   ...
   * Crie o token [Reviews](https://marketing.adobe.com/resources/help/en_US/livefyre/c_reviews_integration.html) CollectionMeta para especificar metadados a serem armazenados na Coleção de revisões.
   * Integre o aplicativo [](https://marketing.adobe.com/resources/help/en_US/livefyre/c_reviews_integration.html) Reviews aos sites usando a estrutura de código incorporada do *Livefyre.js*

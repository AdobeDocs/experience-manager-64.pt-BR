...
Um formulário pode ser usado para coletar as informações de registro e, em seguida, gerar a nova conta e perfil.
...
/home todos permitem jcr:read rep:wide = &amp;ast;/profile&amp;ast;

...
seo-title: Criação e sincronização de cópias em tempo real
...
1. Indique se deseja sincronizar a página após reverter a herança e, em seguida, confirme a ação **Resume** na caixa de diálogo **Retomar Live Copy **.
...
Para habilitar a herança para uma propriedade, clique ou toque no ícone **Reverter herança** que aparece ao lado da propriedade.

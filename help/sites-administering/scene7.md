...
* Verifique se você configurou a configuração em nuvem dessa página por meio das Propriedades **[!UICONTROL da]** página. As predefinições de vídeo estão disponíveis no componente de vídeo do Dynamic Media Classic.

...
1. Entre em contato com o Atendimento ao cliente do Dynamic Media Classic (s7support@adobe.com) para ativar a pré-visualização segura para sua conta do Dynamic Media Classic.

...
1. Para mapear as variáveis CQ para as propriedades do Adobe Analytics, arraste as propriedades do Adobe Analytics do ContentFinder ao lado da variável CQ no componente.
   ...
   Para obter informações sobre como otimizar os mapeamentos, consulte o guia [Medição de vídeo no Adobe Analytics](https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/setup-overview.html) .
...
* O conjunto [estático de variáveis](#milestones) CQ que são definidas para mapeamento com propriedades do Adobe Analytics.
...
>[!NOTE]
>
>Você pode definir um **nome de usuário **do vídeo abrindo o vídeo para edição no DAM e definindo o campo de metadados **Título **como o nome desejado. Também é necessário Salvar as alterações feitas ao terminar.

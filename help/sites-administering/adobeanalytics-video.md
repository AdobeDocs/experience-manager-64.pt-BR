...
>[!NOTE]
>
>Você pode definir um **nome de usuário **do vídeo abrindo o vídeo para edição no DAM e definindo o campo de metadados **Título** para o nome desejado.
...
* O conjunto [estático de variáveis](#milestones) CQ definidas para mapeamento com propriedades do Adobe Analytics.
...
>[!NOTE]
>
>Você pode definir um **nome de usuário **do vídeo abrindo o vídeo para edição no DAM e definindo o campo de metadados **Título** para o nome desejado. Também é necessário Salvar as alterações feitas ao terminar.

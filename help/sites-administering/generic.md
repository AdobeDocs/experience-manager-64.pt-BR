...
1. Especifique:
   ...
   * **Importador**
      ...
      O importador para o [fornecedor de comércio](/help/sites-administering/concepts.md#commerce-providers) específico, por padrão `Geometrixx`.
...
1. Especifique:
   ...
   * **Provedor de comércio**
      ...
      O importador para seu [provedor de comércio](/help/sites-administering/concepts.md#commerce-providers); por padrão, Geometrixx.
...
1. O assistente será aberto. Use os **Básico** e **Guias de produto** para inserir os [atributos de produto](/help/sites-administering/concepts.md#product-attributes) para o novo produto ou variante de produto.
...
1. Os [atributos do produto](/help/sites-administering/concepts.md#product-attributes) serão mostrados. Use **Editar** e **Concluído** para fazer qualquer alteração.
...
1. Alterne para o modo [preview](/help/sites-authoring/editing-content.md#previewing-pages).
...
>[!NOTE]
>
>O catálogo referenciará seus [Dados do produto](#editing-product-information).
...
1. O assistente será aberto. Use as guias **Basic**, **Content**, **Payment** e **Fulfillment** para inserir as [informações sobre o novo pedido](/help/sites-administering/concepts.md#order-information).
...
1. As [informações do pedido](/help/sites-administering/concepts.md#order-information) serão mostradas. Use **Editar** e **Concluído** para fazer qualquer alteração.

...
Para obter mais informações sobre como executar a limpeza de revisão para AEM 6.4, [consulte este artigo dedicado](/help/sites-deploying/revision-cleanup.md).

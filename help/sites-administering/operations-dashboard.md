...
1. A tarefa **Revisão de limpeza **, localizada na seção **Janela de manutenção diária** menu.

1. A tarefa **Limpeza de binários do Lucene **localizada na **Janela de manutenção diária** menu.

1. A tarefa **Workflow purge **localizada na **Janela de manutenção semanal** menu.
...
Para obter mais informações sobre como executar a Revisão de limpeza para o AEM 6.4, [consulte este artigo dedicado](/help/sites-deploying/revision-cleanup.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Um nome exclusivo para a tarefa - é usado para fazer referência à tarefa. Geralmente é um nome simples.</td> 

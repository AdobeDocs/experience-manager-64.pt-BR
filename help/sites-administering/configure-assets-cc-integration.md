...
description: Saiba como configurar a integração do AEM Assets com a Experience Cloud e a Creative Cloud
...
>[!NOTE]
>
>O recurso de compartilhamento de pastas do AEM para a Adobe Creative Cloud está obsoleto. Saiba mais e encontre um método melhor nas práticas [recomendadas de integração do](../assets/aem-cc-integration-best-practices.md)AEM e da Creative Cloud. A configuração do AEM para a replicação da Marketing Cloud e a troca de ativos entre os ativos AEM e a Marketing Cloud não está obsoleta.

![Fluxo de dados quando os ativos AEM e a Creative Cloud são integrados](assets/chlimage_1-287.png)
...
>[!CAUTION]
>
>A marca da Adobe Marketing Cloud foi alterada como Adobe Experience Cloud. Os procedimentos abaixo ainda mencionam a Marketing Cloud para refletir a interface atual.
...
1. Clique em **[!UICONTROL Criar]**. Uma mensagem notifica que o aplicativo é criado.
   ...
   ![Notificação da criação bem-sucedida do aplicativo para integrar os ativos AEM com a Adobe CC](assets/chlimage_1-289.png)
...
1. Na caixa de diálogo **[!UICONTROL Criar configuração]** , especifique um título e nome para a nova configuração e clique em **[!UICONTROL Criar]**.
   ...
   ![Nomear uma nova configuração para integrar os ativos AEM e o CC](assets/cloudservices_configure_mc.png)
...
1. Nos trilhos, vá para **[!UICONTROL Administração]**e clique/toque em **[!UICONTROL Iniciar o Enterprise Dashboard]**.
...
>[!MORELIKETHIS]
* [Práticas recomendadas de integração do AEM e da Creative Cloud](../assets/aem-cc-integration-best-practices.md)
* [Práticas recomendadas de compartilhamento de pastas do AEM para a Creative Cloud](../assets/aem-cc-folder-sharing-best-practices.md)

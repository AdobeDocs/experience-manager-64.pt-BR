...
* [Compartilhamento de pacotes](#package-share), um servidor centralizado com pacotes disponíveis publicamente e privados para sua empresa. Os pacotes públicos podem conter hotfixes, nova funcionalidade, documentação, etc.
...
### Criar um pacote {#building-a-package}
...
Um caso de uso importante para refazer é ao preparar um pacote para o compartilhamento de pacote. Por exemplo, você pode ter um pacote existente e decidir compartilhá-lo com outras pessoas. Para isso, adicione uma miniatura e uma descrição. Em vez de recriar o pacote inteiro com toda a funcionalidade (o que pode levar algum tempo e correr o risco de o pacote não ser mais idêntico ao original), você pode refazer o encapsulamento e adicionar a miniatura e a descrição.
...
>[!NOTE]
>
>Consulte [Compartilhamento de pacotes](#package-share) para obter informações sobre como baixar hotfixes, pacotes de recursos e pacotes da área pública e da área interna de compartilhamento de pacotes da sua empresa.
>
...
>* baixe pacotes de [Compartilhamento de pacotes diretamente na instância de AEM local](#downloading-and-installing-packages-from-package-share).\
   >  Após o download, o pacote é importado para seu repositório, depois disso, você pode instalá-lo imediatamente em sua instância local usando o **Gerenciador de Pacotes**. Esses pacotes incluem hotfixes e outros pacotes compartilhados.
   >
   >
...
>[!NOTE]
>
>Consulte [Upload de pacotes no Compartilhamento de pacotes interno da empresa](#uploading-a-package) para fazer upload de um pacote para a área privada da sua empresa, Compartilhamento de pacotes.
...
* carregado no AEM (ou [carregado do sistema de arquivos](#uploading-packages-from-your-file-system) ou [baixado do compartilhamento de pacotes](#downloading-and-installing-packages-from-package-share))
...
### Replicando pacotes {#replicating-packages}

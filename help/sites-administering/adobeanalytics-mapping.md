...
1. Quando em **AEM visualização**, a lista pode ser filtrada dependendo do tipo de variável selecionado usando os botões de filtro 3:
   ...
   * Se o botão **Traffic** estiver selecionado, a lista mostrará somente as variáveis pertencentes à seção Tráfego
...
1. Quando estiver na visualização do Adobe Analytics, o Localizador de conteúdo exibirá todas as variáveis CQ pertencentes aos componentes de rastreamento arrastados na visualização do CQ.
   ...
   * Por exemplo, se o **Componente de download **for o *somente um arrastado* na visualização CQ (que tem duas variáveis mapeáveis *eventdata.downloadLink* e *eventdata.eventos.startDownload*), o Localizador de conteúdo terá a seguinte aparência ao alternar para a visualização Adobe Analytics:

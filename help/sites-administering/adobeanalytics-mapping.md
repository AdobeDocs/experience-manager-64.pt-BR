...
1. Repita as duas etapas anteriores para outros componentes e variáveis.
   ...
   >* Considerando que os eventos devem ser mapeados para variáveis, começando por `eventdata.events.X`
...
1. As três tabelas (Tráfego, Conversão, Evento) lista todas as variáveis Adobe Analytics disponíveis. pertencente aos RSID selecionados. Os mapeamentos mostrados aqui devem ser os mesmos da visualização AEM:
   ...
   * **Conversão**:
      ...
      * Variável de conversão ( `eVar3`) mapeada para uma expressão javascript adicionada em linha ao clicar com o duplo no campo de variável CQ e inserir o código manualmente
   * **Evento**:

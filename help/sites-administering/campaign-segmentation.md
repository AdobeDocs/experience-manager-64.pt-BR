...
1. Você pode **Editar** a definição do segmento para fornecer um fator **Title**, **Descrição** e **[Aumentar](/help/sites-administering/campaign-segmentation.md#boost-factor)**:
...
1. Pressione **[Ctrl-Alt-C](/help/sites-authoring/keyboard-shortcuts.md)** para abrir o **[Contexto do Cliente](/help/sites-administering/client-context.md)**, que mostra os dados que foram coletados. Para fins de teste, você pode **Editar** determinados valores ou **Carregar** outro perfil para ver o impacto.
...
Os segmentos são usados atualmente em [Campanha](/help/sites-authoring/personalization.md). Eles são usados para direcionar o conteúdo real visualizado por audiências específicas do público alvo. Consulte [Entendendo os segmentos](/help/sites-authoring/segmentation-overview.md) para obter mais informações.

...
>abstract="Como entrada para a calculadora do CTT, os usuários podem estimar o tamanho do Repositório do AEM executando o Relatório de uso de disco em “http://HOST:PORT/etc/reports/diskusage.html”. Os usuários também podem estimar o tamanho de caminhos de repositório específicos usando o parâmetro “caminho”, como: “http://HOST:PORT/etc/reports/diskusage.html?path=/content/dam”."

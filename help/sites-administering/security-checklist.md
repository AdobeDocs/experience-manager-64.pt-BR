...
1. Navegue até** Console de Gerenciamento OSGi do Apache Felix** e altere o **nome de usuário** e **senha**.
...
* [Gerenciador](/help/sites-deploying/osgi-configuration-settings.md) da biblioteca HTML do Adobe Granite:
...
* [Filtro](/help/sites-deploying/osgi-configuration-settings.md) de depuração do WCM CQ do dia:
...
* [Manipulador](/help/sites-deploying/osgi-configuration-settings.md) de script Java do Apache Sling:
...
1. Abra o CRXDE Lite acessando *https://&lt;serrveraddress>:4502/crx/de/index.jsp*

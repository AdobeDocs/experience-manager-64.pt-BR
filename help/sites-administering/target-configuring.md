...
Para localizar a configuração da nuvem e a estrutura, acesse Serviços **da** Cloud por meio de **Ferramentas** > **Implantação** > **Nuvem**. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
...
1. Clique em **Conectar-se ao Target** para inicializar a conexão com o Target. Se a conexão for bem sucedida, será exibida a mensagem** Connection successfully* (Conexão bem sucedida**). Clique em **OK** na mensagem e em **OK** na caixa de diálogo.

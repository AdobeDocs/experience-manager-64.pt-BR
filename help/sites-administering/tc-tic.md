...
* [Clay Tablet Technologies](https://marketing.adobe.com/resources/content/resources/en/exchange/marketplace/apps/clay-tablet-translation-connector-for-aem.html) (não em PackageShare, contate diretamente o fornecedor)
...
>[!NOTE]
>
>Para encontrar a lista mais recente de provedores de tradução automática e humana, veja estas páginas:
>
>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Selecione o provedor de tradução para executar a tradução. Um provedor aparece na lista quando seu conector correspondente está instalado.</td> 
  </tr> 
  <tr> 
...
| Escolha Uma Localidade Para Usar Como Armazenamento De Compartilhamento Global |  (Opcional) Ao selecionar um local para armazenar o UGC, as publicações de todas as cópias de idioma aparecerão em uma conversa global. Por convenção, escolha a localidade para o idioma [](/help/communities/sites-console.md#translation) base do site. Escolher Nenhum armazenamento comum desativará a tradução global. Por padrão, a tradução global está desativada. |
...
1. Na área Integração de tradução, se alguma configuração foi criada, determina qual link será exibido:
   ...
   * Se as configurações já existirem, clique ou toque em Mostrar configurações e clique ou toque no link + exibido ao lado de Configurações disponíveis.
...
Observe que a configuração em nuvem da estrutura de integração de tradução identifica a configuração em nuvem a ser usada para conexão com o provedor de serviços. Quando você associa uma página de origem a uma configuração da estrutura cloud, a página deve estar associada à configuração da nuvem do provedor de serviços que a configuração da estrutura cloud usa.
...
1. No console Sites, selecione a página a ser configurada e clique ou toque em Propriedades da exibição.

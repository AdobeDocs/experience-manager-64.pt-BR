...
6. Em seguida, use o menu suspenso **Run Mode** (ao lado da ID do Report Suite) para selecionar as instâncias do servidor para as quais deseja enviar informações para o Report Suite.
...
Consulte [Ver os dados analíticos da página](/help/sites-authoring/pa-using.md) para obter mais detalhes.

...
description: Esta página lista os Players do AEM Screens com sua respectiva versão do AEM Screens.
...
>[!NOTE]
>
>As informações a seguir são atualizadas a partir de 14 de maio de 2018.

A seção a seguir lista os players do Adobe Experience Manager (AEM) Screens com sua respectiva versão do AEM Screens.

## Player do iOS {#ios-player}

<table> 
 <tbody>
  <tr>
   <td><strong>Versão do servidor AEM</strong></td> 
   <td><strong>Player do iOS</strong></td> 
  </tr>
  <tr>
...
## Player do Android {#android-player}

| **Versão do servidor AEM** | **Player do Android** |
|---|---|
| **AEM 6.3+SP1+Screens FP1(1.0.64_B002)** | **3.2.68 -** (Disponível no site da Macromedia) e na Google Play Store |
...
<table> 
 <tbody>
  <tr>
   ...
   <td><strong>Player do iOS</strong></td> 
   <td><strong>Windows10 Player</strong></td> 
   <td><strong>Player do Chrome OS</strong><br /> </td> 
   <td><strong>Player do Android</strong></td> 
  </tr>
  <tr>
   <td><strong>AEM 6.3+SP1+Screens FP1(1.0.64_B002)</strong></td> 
   ...
   <td><strong>3.2.68 -</strong> (Disponível no site da Macromedia) e na Google Play Store</td> 
  </tr>
  <tr>
   <td><strong><strong>AEM 6.3+SP1+Screens FP2(1.0.298)</strong></strong></td> 

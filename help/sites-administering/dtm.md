...
Ative o serviço de gancho de implantação do Dynamic Tag Management para acessar o AEM para que o serviço possa atualizar as bibliotecas hospedadas pelo AEM. Especifique o endereço IP dos servidores do Dynamic Tag Management que atualizam as bibliotecas de preparação e produção, conforme necessário:

...
>[!NOTE]
>
>Após uma atualização para 6.4, é recomendável mover o arquivo de /etc. Consulte [Reestruturação comum de repositório no AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) para obter mais detalhes.
...
No Editor, você pode marcar/desmarcar **I`s Deep`** no **Filtros** guia .

...
1. Localize **[!UICONTROL Translation Integration]** no **[!UICONTROL Adobe Marketing Cloud]** e clique/toque em **[!UICONTROL Show Configurations (Mostrar configurações]**).

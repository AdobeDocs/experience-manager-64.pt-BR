...
* [Variações - Criação de conteúdo](content-fragments-variations.md) do fragmento - cria o conteúdo do fragmento e as variações do mestre
...
>[!NOTE]
>
>O AEM também oferece suporte à tradução do conteúdo do fragmento. Consulte [Criar projetos de tradução para fragmentos](creating-translation-projects-for-content-fragments.md) de conteúdo para obter mais informações.
...
* **Metadados de fragmento**
   ...
   * Use os esquemas [de metadados de](metadata.md)Ativos.
...
* **Mestre**
   ...
   * O mestre pode ser acessado no editor de fragmentos em **[Variações](content-fragments-variations.md)**.
...
* **Variações**
   ...
   * As variações podem ser [sincronizadas](content-fragments-variations.md#synchronizing-with-master) com o Master se o conteúdo mestre tiver sido atualizado.

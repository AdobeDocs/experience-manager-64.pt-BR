...
Antes de executar qualquer uma das etapas desta metodologia, reveja e implemente as orientações em [Assets Performance Tuning Tips (Dicas](performance-tuning-guidelines.md)de ajuste de desempenho do Assets). Muitas das etapas, como a configuração de trabalhos simultâneos máximos, melhoram consideravelmente a estabilidade e o desempenho do servidor com carga. Outras etapas, como a configuração de um File Data Store, são muito mais difíceis de executar depois que o sistema é carregado com ativos.
...
### Desativar fluxos de trabalho {#disabling-workflows}
...
#### Retire do sistema de arquivos local {#pulling-from-the-local-filesystem}
...
### Ativar fluxos de trabalho {#enabling-workflows}
...
## Migrar ativos em implantações do AEM {#migrating-between-aem-instances}

...
Por padrão, o AEM permite carregar ativos de até 2 GBs. Para fazer upload de ativos muito grandes no AEM, consulte [Configuração para fazer upload de ativos](managing-video-assets.md#configuration-to-upload-video-assets-that-are-larger-than-gb)muito grandes.

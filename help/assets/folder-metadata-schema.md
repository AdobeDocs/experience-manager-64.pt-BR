...
description: Este artigo descreve como criar schemas de metadados para pastas de ativos no AEM Assets
...
Este artigo descreve como criar schemas de metadados para pastas de ativos no AEM Assets.
...
>[!NOTE]
>
>Essa funcionalidade exige AEM 6.4 com pelo menos o Service Pack 2 implantado. Para obter AEM detalhes do service pack 6.4, consulte estas notas [de](/help/release-notes/sp-release-notes.md)versão.

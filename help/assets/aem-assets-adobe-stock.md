...
A integração exige um [plano Adobe Stock corporativo](https://stockenterprise.adobe.com/) e [!DNL Experience Manager] 6.4 com pelo menos o Service Pack 2 implantado. Para obter detalhes sobre o service pack [!DNL Experience Manager] 6.4, consulte estas [notas de versão](/help/release-notes/sp-release-notes.md).
...
1. Clique em **[!UICONTROL Criar novo projeto]** e clique em **[!UICONTROL Adicionar API]**. Selecione **[!UICONTROL Adobe Stock]** na lista de APIs [!UICONTROL disponíveis para você]. Selecione [!UICONTROL OAUTH 2.0 Web]. Configure e copie os vários valores apresentados.
...
>[!NOTE]
>
>Se houver várias [!DNL Adobe Stock] configurações, selecione a configuração desejada no painel Preferências de usuário (**[!UICONTROL AEM]** > **[!UICONTROL Ícone de usuário]** > **[!UICONTROL Preferências de usuário]** > **[!UICONTROL Configuração de estoque]**).
...
![Procure ativos do Adobe Stock e filtre os resultados de sua área de trabalho do Adobe Experience Manager](assets/adobe-stock-search-results-workspace.png)

*Figura: Procure  [!DNL Adobe Stock] ativos e filtre os resultados de sua  [!DNL Experience Manager] interface.*
...
* Para procurar ativos em [!DNL Adobe Stock] e [!DNL Experience Manager Assets], clique em pesquisar ![ícone_de_pesquisa](assets/search_icon.png).
...
>[!MORELIKETHIS]
>
>* [Tutorial em vídeo sobre como usar ativos Adobe Stock com ativos Experience Manager](https://helpx.adobe.com/experience-manager/kt/assets/using/stock-assets-feature-video-use.html)

...
Para abrir as **[!UICONTROL Coleções]**, toque ou clique no logotipo do Experience Manager. Na página de navegação, vá para **[!UICONTROL Ativos]** > **[!UICONTROL Coleções]**.
...
1. Na interface do usuário do Assets, selecione o ativo e toque/clique no ícone **[!UICONTROL Para coleção]** na barra de ferramentas.
...
1. Para anexar os novos metadados aos metadados existentes, selecione **[!UICONTROL Modo Anexar]**. Se você não selecionar essa opção, os novos metadados substituirão os existentes nos campos. Toque/clique em **[!UICONTROL Enviar]**.
...
1. Na caixa de diálogo **[!UICONTROL Baixar]**, toque/clique em **[!UICONTROL Baixar]**. Se desejar baixar as representações dos ativos dentro da coleção, selecione **[!UICONTROL Representações]**. Selecione a opção **[!UICONTROL Email]** para enviar uma notificação por email ao proprietário da coleção.
...
Pesquisas salvas são criadas quando você cria uma coleção inteligente. As coleções inteligentes são adicionadas automaticamente à lista **[!UICONTROL Pesquisas salvas]**. O query Pesquisas salvas para a coleção é salvo na propriedade `dam:query` no crxde no local relativo `/content/dam/collections/`. Não há limites para as pesquisas que você pode salvar e nas pesquisas salvas exibidas na lista.
...
Editar pesquisas salvas é o mesmo que editar coleções inteligentes. Para obter detalhes, consulte [Editar uma coleção inteligente](/help/assets/managing-collections-touch-ui.md#editing-a-smart-collection).
...
1. Na lista **[!UICONTROL Pesquisas salvas]**, toque/clique no ícone de exclusão ao lado da coleção inteligente que você deseja excluir.

...
* O JPG comprime a uma proporção de 10:1 e geralmente produz tamanhos de arquivo de imagem menores. O PNG é compactado em uma proporção de cerca de 2:1, exceto em alguns casos, como quando imagens contêm um fundo branco. Normalmente, porém, os tamanhos dos arquivos PNG são maiores que os arquivos JPG.
...
A nitidez da imagem é o aspecto mais complexo do controle de imagens em seu site, e onde muitos erros são cometidos. Reserve tempo para saber mais sobre como a nitidez e o mascaramento nítido funcionam no AEM, referindo-se ao [Práticas recomendadas de qualidade e nitidez da imagem do Adobe Dynamic Media Classic](/help/assets/assets/sharpening_images.pdf) guia que se aplica a AEM também.
...
* Mascaramento nítido ( `&op_USM`) - O mascaramento com nitidez é um filtro de nitidez padrão do setor. A prática recomendada é aprimorar as imagens com máscara nítida seguindo as diretrizes abaixo. O mascaramento de nitidez permite controlar os três parâmetros a seguir:
   ...
   * `&op_sharpen=`quantia,raio,limite
      ...
      * **[!UICONTROL limite]** (0-255, sensibilidade do efeito.)
         ...
         Para obter mais informações sobre como você define esses três parâmetros, incluindo práticas recomendadas para usar com o filtro, consulte o [Práticas recomendadas de qualidade e nitidez da imagem do Adobe Dynamic Media Classic](/help/assets/assets/sharpening_images.pdf) guia (aplica-se ao Dynamic Media no AEM também).
...
### Práticas recomendadas para compactação de JPEG (&amp;qlt=) {#best-practices-for-compression-qlt}
...
* O AEM também fornece maneiras mais avançadas de ajustar a qualidade da imagem, como aplicar imagens de nitidez na assimilação. Para casos de uso avançado em que essa pode ser uma opção para ajustar e otimizar os resultados de renderização, [Adobe Professional Services](https://business.adobe.com/br/customers/consulting-services/main.html) O pode ajudá-lo com informações personalizadas e práticas recomendadas.

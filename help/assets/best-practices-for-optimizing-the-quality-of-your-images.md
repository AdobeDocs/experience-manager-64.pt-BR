...
White paper de práticas recomendadas [O ajuste de nitidez de imagens no Adobe Scene7 Publishing System e no Image Server](/help/assets/assets/s7_sharpening_images.pdf) também se aplica a AEM.

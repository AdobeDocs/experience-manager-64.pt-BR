...
1. Faça uma das seguintes opções:
   ...
   * Toque no ícone ![](assets/do-not-localize/aem_assets_add_icon.png) Adicionar ao lado do campo Opções para especificar o texto de exibição e o valor das opções que deseja fornecer no painel Filtros. Para adicionar outra opção, toque/clique no ícone ![Adicionar](assets/do-not-localize/aem_assets_add_icon.png) e repita a etapa.

...
Os Modelos de fragmentos do conteúdo definem a estrutura do conteúdo para [fragmentos de conteúdo](content-fragments.md).

## Ativar modelos de fragmento de conteúdo {#enable-content-fragment-models}

>[!CAUTION]
>
>Se você não ativar **[!UICONTROL Modelos de fragmentos do conteúdo]**, o **[!UICONTROL Criar]** não estará disponível para criar novos modelos.
...
Para [criar um novo Modelo de fragmento de conteúdo](#creating-a-content-fragment-model) you **must** primeiro ative-os usando o Gerenciador de configuração:

1. Navegue até **[!UICONTROL Ferramentas]**, **[!UICONTROL Geral]**, e abra o **[!UICONTROL Navegador de configuração]**.
...
1. Selecione **[!UICONTROL Criar]** para abrir a caixa de diálogo, onde você:

   1. Especifica um **[!UICONTROL Título]**.
   1. Selecionar **[!UICONTROL Modelos de fragmentos do conteúdo]** para permitir a sua utilização.
...
Quando a configuração **[!UICONTROL global]** estiver ativado para modelos de fragmento de conteúdo, os modelos criados pelos usuários podem ser usados em qualquer pasta do Assets.
...
1. Navegar para **[!UICONTROL Ferramentas]**, **[!UICONTROL Ativos]**, depois abra **[!UICONTROL Modelos de fragmentos do conteúdo]**.
...
1. Use **[!UICONTROL Criar]** para abrir o assistente.
   ...
   >[!CAUTION]
   >
   >Se o [uso de modelos de fragmento de conteúdo não foi habilitado](#enable-content-fragment-models), a opção **Criar** não estará disponível.
...
1. Abra o modelo necessário para **[!UICONTROL Edição]**; use a ação rápida ou selecione o modelo e depois a ação na barra de ferramentas.

   Uma vez aberto, o editor de modelo mostra:

   * à esquerda: campos já definidos
   * à direita: **[!UICONTROL Tipos de dados]** disponíveis para criar campos (e **[!UICONTROL Propriedades]** para uso depois que os campos forem criados)

   >[!NOTE]
   >
   >Quando um campo é **Obrigatório**, o **Rótulo** indicada no painel esquerdo será marcada com um asterisco (**&amp;ast;**).
...
1. Depois de adicionar todos os campos obrigatórios e definir as propriedades, use **[!UICONTROL Salvar]** para manter a definição. Por exemplo:
...
1. Navegue até a pasta que contém o modelo de fragmento de conteúdo.
1. Selecione seu modelo e, em seguida, **[!UICONTROL Excluir]** na barra de ferramentas.
...
1. Navegue até a pasta que contém o modelo de fragmento de conteúdo.
1. Selecione seu modelo e, em seguida, **[!UICONTROL Publicar]** na barra de ferramentas.

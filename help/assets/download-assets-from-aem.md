...
description: Saiba como baixar ativos de [!DNL Adobe Experience Manager] e ativar ou desativar a funcionalidade de download.
contentOwner: AG
...
1. No canto superior esquerdo do AEM, toque no logotipo AEM e, em seguida, no painel esquerdo, toque em **[!UICONTROL Navegação]**.
...
1. Na barra de ferramentas, toque em **[!UICONTROL Download.]**
   ...
   ![Opções disponíveis ao baixar ativos dos ativos Experience Manager](/help/assets/assets/asset_download_dialog.png)
...
1. Na caixa de diálogo Download, selecione as opções de download desejadas.
   ...
   | **[!UICONTROL Assets]** | Selecione essa opção para baixar o ativo em seu formulário original sem execuções.<br>A opção de subativos estará disponível se o ativo original tiver subativos. |
...
O servlet padrão em [!DNL Experience Manager] permite que os usuários autenticados emitam solicitações de download arbitrariamente grandes e simultâneas para a criação de arquivos ZIP de ativos visíveis a eles que podem sobrecarregar o servidor e a rede. Para atenuar os possíveis riscos do DoS causados por esse recurso, `AssetDownloadServlet` o componente OSGi é desabilitado por padrão para instâncias de publicação.

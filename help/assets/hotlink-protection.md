...
[O Suporte](https://helpx.adobe.com/support.html) a Adobe pode configurar um filtro de quem indicou no nível CDN para que o conteúdo do Dynamic Media seja disponibilizado somente para sites na lista de sites permitidos para o domínio.

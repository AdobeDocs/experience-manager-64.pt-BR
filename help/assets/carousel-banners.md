...
1. [Adicione pontos de acesso ou mapas de imagem a um banner de imagem.](#adding-hotspots-or-image-maps-to-an-image-banner)
   ...
   Consulte [(Opcional) Visualização de banners](#optional-previewing-carousel-banners) de carrossel - Opcional. Se desejar, você pode visualização uma representação do conjunto de carrossel e testar sua interatividade.
...
1. Faça uma das seguintes opções:
   ...
   * [Adicione um banner de carrossel ao seu site em AEM](adding-dynamic-media-assets-to-pages.md) Se você for um cliente da AEM Sites, poderá adicionar o conjunto de carrossel diretamente à página em AEM, usando o componente de Mídia interativa.


Se precisar editar Conjuntos de carrossel, consulte [edição de Conjuntos](#editing-carousel-sets)de carrossel. Além disso, você pode visualização e editar as propriedades [do Conjunto de](/help/assets/managing-assets-touch-ui.md#editing-properties)carrossel.
...
Quando terminar de criar o banner do carrossel, você pode usar a **[!UICONTROL Pré-visualização]** opcionalmente para ver uma representação de como o banner do carrossel será exibido aos clientes.
...
1. Execute um dos procedimentos a seguir na guia **[!UICONTROL Ações]** :
   ...
   * Toque em **[!UICONTROL Quickview]**.
      ...
      * Se você for um cliente da AEM Sites e do Ecommerce, toque no ícone Seletor **[!UICONTROL de]** produtos (lupa) para abrir a página **[!UICONTROL Selecionar produto]** . Toque no produto que deseja usar e, em seguida, toque na marca de seleção no canto superior direito da página para retornar ao Editor **[!UICONTROL de banner do]** carrossel.
   ...
   * Toque em **[!UICONTROL Hiperlink]**.
      ...
      * Se você for um cliente AEM Sites, toque no ícone Seletor **[!UICONTROL de]** site (pasta) para navegar até um URL.
...
Você pode usar a **[!UICONTROL Pré-visualização]** para ver a aparência do seu banner de carrossel para os clientes e testar os pontos de conexão e mapas de imagem dos banners de carrossel para garantir que eles estejam se comportando como esperado.
...
1. Em **[!UICONTROL Ativos]**, navegue até um banner de carrossel existente que você criou e toque para abri-lo.
1. Perto do canto superior esquerdo da página de **[!UICONTROL Pré-visualização]** , toque no ícone **[!UICONTROL Conteúdo]** .
...
Se você for um cliente da AEM Sites, poderá adicionar o banner do carrossel diretamente à sua página arrastando o componente de Mídia interativa para a página. See [Adding Dynamic Media Assets to Pages.](adding-dynamic-media-assets-to-pages.md)

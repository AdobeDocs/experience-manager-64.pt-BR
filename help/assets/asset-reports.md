...
* Ative o serviço [!UICONTROL Gravador de Evento do Day CQ DAM] de **[!UICONTROL Ferramentas]** > **[!UICONTROL Operações]** > **[!UICONTROL Console da Web]**.
* Selecione as atividades ou eventos em que deseja relatórios. Por exemplo, para gerar um relatório sobre ativos baixados, selecione [!UICONTROL Ativo baixado (DOWNLOADED)].
...
1. Na página **[!UICONTROL Criar relatório]**, escolha o relatório que deseja criar e clique em **[!UICONTROL Próximo]**.
   ...
   >[!NOTE]
   >
   >Por padrão, os Fragmentos de conteúdo e compartilhamentos de link estão incluídos no ativo [!UICONTROL Relatório baixado]. Selecione a opção apropriada para criar um relatório de compartilhamentos de link ou para excluir Fragmentos de conteúdo do relatório de download.

   >[!NOTE]
   >
   >O relatório [!UICONTROL Download] exibe detalhes somente dos ativos que foram selecionados individualmente e baixados ou baixados usando a Ação rápida. No entanto, não inclui os detalhes dos ativos que estavam dentro de uma pasta baixada.

...
description: 'O Dynamic Media já vem com um perfil de Codificação de vídeo adaptável predefinido. As configurações neste perfil predefinido são otimizadas para fornecer aos clientes a melhor experiência de visualização possível. '
seo-description: 'O Dynamic Media já vem com um perfil de Codificação de vídeo adaptável predefinido. As configurações neste perfil predefinido são otimizadas para fornecer aos clientes a melhor experiência de visualização possível. '
...
* **Tamanho do player de vídeo**
   ...
   Por padrão, a **[!UICONTROL Largura]** no perfil de Codificação de vídeo adaptável é definida como **[!UICONTROL Automática]**. Novamente, durante a reprodução, a melhor qualidade é usada com base no tamanho do player.
...
>
>Os metadados são úteis quando você está procurando ativos. As miniaturas são imagens de vídeo estáticas geradas durante a codificação. Elas são exigidas pelo sistema AEM e usadas na interface do usuário para ajudar a identificar visualmente os vídeos na exibição **[!UICONTROL de]** Cartões, na exibição de Resultados **[!UICONTROL da]** pesquisa e na exibição de Lista **[!UICONTROL de]** ativos. É possível ver as miniaturas geradas ao tocar no ícone **[!UICONTROL Representações]** (paleta do pintor) de um vídeo codificado.
...
## Criação de um perfil de codificação de vídeo do Dynamic Media para transmissão adaptável {#creating-a-video-encoding-profile-for-adaptive-streaming}
...
## Criação de um perfil de codificação de vídeo do Dynamic Media para streaming progressivo {#creating-a-video-encoding-profile-for-progressive-streaming}
...
1. No canto superior esquerdo da página **[!UICONTROL CRXDE Lite]** , toque no ícone Início **[!UICONTROL traseiro]** para retornar ao AEM.
...
1. Na página Perfil **[!UICONTROL de codificação de]** vídeo, edite o nome e a descrição, conforme desejado.
...
1. Na página Perfil **[!UICONTROL de codificação de]** vídeo, digite um novo nome para o perfil.
...
1. Toque no logotipo do AEM e navegue até **[!UICONTROL Assets]** e, em seguida, para a pasta à qual deseja aplicar um perfil de vídeo.
...
1. Toque no logotipo do AEM e navegue até **[!UICONTROL Assets]** e, em seguida, para a pasta da qual deseja remover um perfil de vídeo.
1. Na pasta, toque na marca de seleção para selecioná-la e, em seguida, toque em **[!UICONTROL Propriedades]**.

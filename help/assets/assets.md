...
* **Versões**: O controle de versão cria um instantâneo de ativos digitais em um ponto específico no tempo. Você pode restaurar ativos para versões anteriores. Consulte [controle de versão em [!DNL Assets]](managing-assets-touch-ui.md#asset-versioning).
...
>[!MORELIKETHIS]
>
>* [Introdução ao vídeo - Ativos Experience Manager como um DAM moderno](https://www.youtube.com/watch?v=PBwQqZgC-yo)

...
### Fluxo de trabalho do DAM Update Asset Offloading {#dam-update-asset-offloading-workflow}
...
### Gerenciador de tarefas {#job-manager}
...
### AEM descarregamento {#aem-offloading}
...
Depois que um trabalho é gravado no trabalhador, o gerente de trabalho chama o consumidor de trabalho responsável pelo tópico *com/adobe/granite/workflow/offloading*. O consumidor do trabalho executa o fluxo de trabalho Atualizar ativo DAM no ativo.
...
### A transferir tarefas distribuídas {#sling-distributed-jobs}
...
### Estrutura de descarga de granito {#granite-offloading-framework}
...
## Diretrizes gerais e práticas recomendadas para a descarga de ativos {#general-guidance-and-best-practices-for-asset-offloading}
...
### Usando replicação direta {#using-forward-replication}
...
1. Abra a configuração de componente do componente *OffloadingDefaultTransporter* em [http://localhost:4502/system/console/configMgr/com.adobe.granite.offloading.impl.transporter.OffloadingDefaultTransporter](http://localhost:4502/system/console/configMgr/com.adobe.granite.offloading.impl.transporter.OffloadingDefaultTransporter)
1. Desative a propriedade *Pacote de Replicação (default.transport.contentpackage)*.

### Desabilitando o transporte do modelo de fluxo de trabalho {#disabling-the-transport-of-workflow-model}

Por padrão, o fluxo de trabalho de descarregamento *DAM Update Asset Offloading* adiciona o modelo de fluxo de trabalho para chamar o trabalhador à carga do trabalho. Como esse fluxo de trabalho segue o modelo predefinido *Ativo de atualização do DAM*, por padrão, essa carga adicional pode ser removida.
...
1. Abra o console de fluxo de trabalho de [http://localhost:4502/libs/cq/workflow/content/console.html](http://localhost:4502/libs/cq/workflow/content/console.html).
...
### Otimizando o intervalo de polling {#optimizing-the-polling-interval}

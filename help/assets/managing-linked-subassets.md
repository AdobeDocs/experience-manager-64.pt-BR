...
1. Usando o aplicativo [](https://helpx.adobe.com/experience-manager/desktop-app/aem-desktop-app.html)AEM para desktop, monte o repositório AEM Assets como uma unidade em sua máquina local. Na unidade montada, navegue até o local do ativo que deseja referenciar.
1. Arraste o ativo da unidade montada para o arquivo do Illustrator.
1. Salve o arquivo do Illustrator na unidade montada ou [carregue](managing-assets-touch-ui.md#uploading-assets) no repositório do AEM.
...
Os ativos referenciados já existem nos ativos AEM. Você pode extrair subativos [configurando o servidor](indesign.md)do InDesign. Os ativos incorporados em um arquivo do InDesign são extraídos como subativos.

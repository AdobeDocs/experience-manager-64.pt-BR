...
1. Para pesquisar ativos com base em seu status, clique/toque no ícone **[!UICONTROL Pesquisar]** para exibir a barra de pesquisa Omni.
...
>[!NOTE]
>
>O local */etc/dam/drm/license* usado para armazenar licenças em versões anteriores do AEM está obsoleto.
>
>Se você criar ou modificar páginas de licença ou as portar de versões anteriores do AEM, a Adobe recomenda armazená-las em */apps/settings/dam/drm/license* ou */conf/&amp;ast;/settings/dam/drm/license*.

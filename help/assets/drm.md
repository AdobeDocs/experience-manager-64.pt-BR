...
1. Escolha **[!UICONTROL Referências]** no menu.
   ...
   Se o ativo tiver subativos expirados, o painel Referências exibirá o status **[!UICONTROL O ativo tem subativos expirados]**.
...
1. Escolha **[!UICONTROL Expired]**. Os ativos expirados são exibidos nos resultados da pesquisa.
